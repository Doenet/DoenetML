  ...
  <p>Unordered: <answer>
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.get(mathinputAnchor).type(
                "{ctrl+home}{shift+end}{backspace}(1,3)",
                {
                    force: true,
                    delay: 0,
                }
            ...
            cy.get(mathinput2Anchor).type(
                "{ctrl+home}{shift+end}{backspace}2",
                {
                    force: true,
                    delay: 0,
                }
            ...
            cy.get(mathinputPartialAnchor).should("have.text", "33 %");
            cy.get(mathinput2Anchor).type(
                "{ctrl+home}{shift+end}{backspace}1",
                {
                    force: true,
                    delay: 0,
                }
            ...
            cy.get(mathinputAnchor).type(
                "{ctrl+home}{shift+end}{backspace}(3,1)",
                {
                    force: true,
                    delay: 0,
                }
  ...
  <p>No partial: <answer>
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.log("Submit correct answers");
            cy.get(mathinputAnchor).type("{{}1,2,3}", {
                force: true,
                delay: 0,
            });
            cy.get(mathinputSubmitAnchor).click();
            cy.get(mathinputCorrectAnchor).should("be.visible");
            cy.get(mathinput2Anchor).type("{{}1,2,3}", {
                force: true,
                delay: 0,
            });
            cy.get(mathinput2SubmitAnchor).click();
            ...
            cy.get(mathinputPartialAnchor).should("have.text", "33 %");
            cy.get(mathinput2Anchor).type(
                "{ctrl+home}{shift+end}{backspace}3",
                {
                    force: true,
                    delay: 0,
                }
  ...
  <p>Right open, no partial: <answer>
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.get(mathinputAnchor).type(
                "{ctrl+home}{shift+end}{backspace}(1,2)",
                {
                    force: true,
                    delay: 0,
                }
            ...
            cy.get(mathinputAnchor).type(
                "{ctrl+home}{shift+end}{backspace}(3,2)",
                {
                    force: true,
                    delay: 0,
                }
  ...
  <section><title>Unordered</title>
    ...
    <award>
      ...
      `,
        ...
        cy.log("Submit correct answers");
        cy.get(cesc("#\\/x") + " textarea").type("x", {
            force: true,
            delay: 0,
        });
        cy.get(cesc("#\\/y") + " textarea").type("y", {
            force: true,
            delay: 0,
        });
        cy.get(cesc("#\\/z") + " textarea").type("z", {
            force: true,
            delay: 0,
        });
