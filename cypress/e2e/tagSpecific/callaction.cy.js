    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            await win.callAction1({
                ...
                componentName:
                    g1.stateValues.graphicalDescendants[1].componentName,
                args: { x: -2, y: 5 },
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            await win.callAction1({
                actionName: "movePoint",
                componentName:
                    g2.stateValues.graphicalDescendants[2].componentName,
                args: { x: 7, y: -9 },
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            await win.callAction1({
                actionName: "movePoint",
                componentName:
                    g3.stateValues.graphicalDescendants[1].componentName,
                args: { x: 1, y: 0 },
            });
        });
