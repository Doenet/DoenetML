...
describe("Select Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables["/noresamplep"].activeChildren[1]
                            .componentName
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables["/noreresamplep"].activeChildren[1]
                            .componentName
                    ].activeChildren[0].componentName
                ].stateValues.value
            ).eq(x1);
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let a2 = me
                .fromAst(stateVariables["/a2"].stateValues.value)
                .toString();
            let b2 = me
                .fromAst(stateVariables["/b2"].stateValues.value)
                .toString();
            let c2 = me
                .fromAst(stateVariables["/c2"].stateValues.value)
                .toString();
            let d2 = me
                .fromAst(stateVariables["/d2"].stateValues.value)
                .toString();
            let v2 = me
                .fromAst(stateVariables["/v2"].stateValues.value)
                .toString();
            let w2 = me
                .fromAst(stateVariables["/w2"].stateValues.value)
                .toString();
