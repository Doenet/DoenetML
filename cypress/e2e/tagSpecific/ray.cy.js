...
describe("Ray Tag Tests", function () {
 ...
 `,
  ...
  `,
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            expect(stateVariables["/original"].stateValues.endpoint).eqls([
                0, 0,
            ]);
            expect(stateVariables["/original"].stateValues.through).eqls([
                1, 3,
            ]);
            expect(stateVariables["/multiplied"].stateValues.endpoint).eqls([
                0, 0,
            ]);
            expect(stateVariables["/multiplied"].stateValues.through).eqls([
                2, 6,
            ]);
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v"].stateValues.endpoint).eqls([
                    tx,
                    ty,
                ]);
                expect(stateVariables["/v"].stateValues.through).eqls([hx, hy]);
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/_ray2"].stateValues.endpoint).eqls([
                x3,
                y3,
            ]);
            expect(stateVariables["/_ray2"].stateValues.through).eqls([x2, y2]);
            expect(stateVariables["/_ray3"].stateValues.endpoint).eqls([
                x3,
                y3,
            ]);
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/_ray2"].stateValues.through).eqls([
                    x2,
                    y2,
                ]);
                expect(stateVariables["/_ray3"].stateValues.endpoint).eqls([
                ...
                expect(stateVariables["/_ray3"].stateValues.through).eqls([
                    x1,
                    y1,
                ]);
            });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v1"].stateValues.direction).eqls([
                    0, 0,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v1"].stateValues.endpoint).eqls([
                    -4, 5,
                ]);
                expect(stateVariables["/v1"].stateValues.direction).eqls([
                    0, 0,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v3"].stateValues.direction).eqls([
                    0, 0,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v3"].stateValues.endpoint).eqls([
                    -4, 5,
                ]);
                expect(stateVariables["/v3"].stateValues.direction).eqls([
                    0, 0,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v2"].stateValues.endpoint).eqls([0, 0]);
                expect(stateVariables["/v2"].stateValues.direction).eqls([
                    1, 2,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                let stateVariables = await win.returnAllStateVariables1();
                expect(stateVariables["/v2"].stateValues.through).eqls([
                    -4, -5,
                ]);
                expect(stateVariables["/v2"].stateValues.endpoint).eqls([0, 0]);
                expect(stateVariables["/v2"].stateValues.direction).eqls([
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v5"].stateValues.endpoint).eqls([0, 0]);
                expect(stateVariables["/v5"].stateValues.direction).eqls([
                    1, 2,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                let stateVariables = await win.returnAllStateVariables1();
                expect(stateVariables["/v5"].stateValues.through).eqls([
                    -4, -5,
                ]);
                expect(stateVariables["/v5"].stateValues.endpoint).eqls([0, 0]);
                expect(stateVariables["/v5"].stateValues.direction).eqls([
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                let stateVariables = await win.returnAllStateVariables1();
                expect(stateVariables["/v4"].stateValues.through).eqls([
                    -8, -6,
                ]);
                expect(stateVariables["/v4"].stateValues.endpoint).eqls([
                    -4, -3,
                ]);
                expect(stateVariables["/v4"].stateValues.direction).eqls([
                    -4, -3,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                let stateVariables = await win.returnAllStateVariables1();
                expect(stateVariables["/v6"].stateValues.through).eqls([
                    -8, -6,
                ]);
                expect(stateVariables["/v6"].stateValues.endpoint).eqls([
                    -4, -3,
                ]);
                expect(stateVariables["/v6"].stateValues.direction).eqls([
                    -4, -3,
                ]);
            });
        });
