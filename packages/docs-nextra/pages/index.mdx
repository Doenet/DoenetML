...
2. [**Reference**](reference/componentIndex.mdx) : quick-start guide, technical documentation and component examples
3. [**Sandbox**](sandbox0.mdx) : immediately experiment with DoenetML code snippets
