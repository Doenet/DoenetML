...
When an open marker — or any visual difference — is meant to *carry meaning*, such as an excluded interval endpoint, reach for a semantic component like `<endpoint>{:dn}` rather than styling a plain point. See [Some distinctions have a name: semantic components](../concepts/styling#some-distinctions-have-a-name-semantic-components) for why this matters.
</Callout>
