...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A circle of radius 5 with an editable equation label</shortDescription>
  <math 
    name="math1" 
    anchor="$miAnchor" 
    hide="$biHide" 
...
<p>Adjust attribute values:</p>
  <p>
    <mathInput name="miAnchor" prefill="(-3,3)"><label>anchor (x,y)</label></mathInput>
  </p>

  <p>
    <booleanInput name="biHide"><label>hide (true/false)</label></booleanInput>
  </p>

  <p>
    <booleanInput name="biDraggable" prefill="true"><label>draggable (true/false)</label></booleanInput>
  </p>

  <p>
    <mathInput name="miStyleNumber" prefill="3"><label>styleNumber (1-6)</label></mathInput>
  </p>

  <p>
    <mathInput name="miLayer" prefill="1"><label>layer (0,1,2,...)</label></mathInput>
  </p>
```
...
<graph size="small">
  <shortDescription>A graph displaying the math expression x^2</shortDescription>
...
<graph size="small">
  <shortDescription>A graph showing two vectors</shortDescription>
  $math1.vector
  $math2.vector
</graph>
```
