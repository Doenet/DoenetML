...
<p>Enter tTkLp with any capitalization: <answer type="text" caseInsensitiveMatch>ttklp</answer></p>
...
<p>(Though it generally wouldn't make sense to show the credit if you're hiding correctness, you <em>could</em> 
show the credit achieved: $ans1.creditAchieved.)</p>

  <p>Try again with a big button</p>
    <m>\sqrt{529} = </m> 
  <answer name="ans2" showCorrectness="false" symbolicEquality forceFullCheckworkButton>23</answer> 
...
```doenet-example
<p>Given an angle <m>\theta</m> on the unit circle, what is the name for the ratio of the opposite side to the hypotenuse?
