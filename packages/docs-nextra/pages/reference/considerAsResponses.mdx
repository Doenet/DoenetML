...
<ComponentDisplay name='considerAsResponses'/>

`<considerAsResponses>{:dn}` is an [Evaluation](../concepts/essentialConcepts#component-types)
...
<p>
  <choiceInput name="animal">
    <label>Choose your favorite rodent</label>
    <choice>dog</choice>
