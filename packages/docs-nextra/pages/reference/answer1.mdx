...
<ComponentDisplay name='answer'/>

## Basic Use Examples


`<answer>{:dn}` is an [Evaluation](../concepts/essentialConcepts#component-types) component that
...
```doenet-example
<p><answer><label><m>7x + 3x = </m></label>10x</answer></p>
```
...
```doenet-example
<p><answer type="text"><label>Type <c>banana</c></label>banana</answer></p>
```
