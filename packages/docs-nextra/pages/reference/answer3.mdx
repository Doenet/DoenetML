...
<p><c>forceSmallCheckWorkButton</c> = $ans.forceSmallCheckWorkButton</p>
...
<answer name="ans1">
  <mathInput name="input1"><shortDescription>first number</shortDescription></mathInput>
  <mathInput name="input2"><shortDescription>second number</shortDescription></mathInput>
  <mathInput name="input3"><shortDescription>third number</shortDescription></mathInput>
  <award>
    <when>
...
<graph size="small">
  <shortDescription>graph for moving points A and B</shortDescription>
...
```doenet-editor-horiz
<p>
    <answer name="ans1"><label>The ratio of a circle's circumference to its diameter is</label>pi</answer></p>
...
<answer name="ans">
  <shortDescription>enter x</shortDescription>
...
```doenet-editor-horiz
<p>
  <answer name="ans1" maxNumAttempts="3"><label>The ratio of a circle's circumference to its diameter is</label>pi</answer></p>
