...
<ComponentDisplay name='else'/>

`<else>{:dn}` is a [Logic](../concepts/essentialConcepts#component-types) 
...
```doenet-example
<p><textInput name="userLetter" prefill="type letter here"><label>Type in the letter A, B, or C</label></textInput></p>
<conditionalContent>
