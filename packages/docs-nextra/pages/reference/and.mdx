...
<ComponentDisplay name='and'/>

`<and>{:dn}` is a [Logic](../concepts/essentialConcepts#component-types) component
...
```doenet-editor-horiz
<p><mathInput name="n"><label>Enter a number between 5 and 10, excluding 7</label></mathInput></p>
