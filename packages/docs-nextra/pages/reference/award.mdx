...
<ComponentDisplay name='award'/>

`<award>{:dn}` is 
an [Evaluation](../concepts/essentialConcepts#component-types) component 
...
<p>
  <answer>
    <mathInput name="ans1"><label>1. Enter <m>a</m> or <m>b</m></label></mathInput>
    <award>a</award>
    <award>b</award>
  </answer>
</p>  
...
<p>
  <answer>
    <mathInput name="input1"><label>Enter a number greater than 2</label></mathInput>
    <award>
      <when>$input1 > 2</when>
    </award>
  </answer>
