...
import { ComponentDisplay, AttrDisplay, PropDisplay } from "../../components"


# `<function>{:dn}`

<ComponentDisplay name='function'/>
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>two interpolated functions</shortDescription>
...
Move the points
<graph size="small">
  <shortDescription>interpolated function with movable extrema points</shortDescription>
