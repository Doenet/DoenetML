...
<ComponentDisplay name='controlVectors'/>

`<controlVectors>{:dn}`  is a [Graphical](../concepts/essentialConcepts#component-types)
...
<graph size="small">
  <shortDescription>A graph of a bezier curve with control vectors specified directly</shortDescription>
...
<graph size="small">
  <shortDescription>A graph of a bezier curve with control vectors as vector children</shortDescription>
...
<p>Set control vector(s) for middle point: 
  <mathInput name="vList1" prefill="(-5,1)"><shortDescription>First control vector</shortDescription></mathInput>
  <mathInput name="vList2" prefill="(3,4)"><shortDescription>Second control vector</shortDescription></mathInput>
</p>
...
<graph>
<shortDescription>A graph of a bezier curve showing different direction options for control vectors</shortDescription>
...
```doenet-editor-horiz
<graph size="small">
<shortDescription>A graph of a bezier curve with a control vector at the third point</shortDescription>
...
```doenet-editor-horiz
<graph size="small">
<shortDescription>A graph of a bezier curve with control vectors with different directions</shortDescription>
