...
<ComponentDisplay name='derivative'/>

`<derivative>{:dn}` is a [Math](../concepts/essentialConcepts#component-types) 
...
<graph size="small">
  <shortDescription>graph of the derivative</shortDescription>
  $fPrime
</graph>
```
