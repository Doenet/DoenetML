...
<ComponentDisplay name='updateValue'/>

`<updateValue>{:dn}` is a [General Operator](../document_structure/essentialConcepts#component-types) 
...
<graph size="small">
  <shortDescription>A graph of a line</shortDescription>
...
<p><answer name="ans1"><label>What is the radius of the circle?</label>$circ.radius</answer></p>   
...
<graph size="small">
  <shortDescription>A graph of a movable point</shortDescription>
  <point name="p"/>
</graph>     
```
...
<graph size="small">
  <shortDescription>A graph of a clickable point with a label</shortDescription>
  <point name="p"/>
