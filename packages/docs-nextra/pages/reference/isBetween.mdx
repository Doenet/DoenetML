...
<ComponentDisplay name='isBetween'/>

`<isBetween>{:dn}` is a [Logic](../concepts/essentialConcepts#component-types) component
...
```doenet-editor-horiz
<p><mathInput name="mi" prefill="0"><label>Enter a number</label></mathInput></p>
