...
1. It colors the border of the math input based on the correctness of the response (assuming `colorCorrectness` is set).
...
<p>Alternate way to access the bound radius: <mathInput>$circ.radius</mathInput></p>
```
