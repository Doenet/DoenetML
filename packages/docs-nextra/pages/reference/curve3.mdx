...
```doenet-example
<graph size="small">
  <shortDescription>A graph of a curve C1 with bezier controls</shortDescription>
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a parametric curve</shortDescription>
...
```doenet-example
<graph size="small">
  <shortDescription>A graph of a curve with named control vectors</shortDescription>
  <curve name="curve1" through="(1,5) (-3,-6) (1,0) (-6,3)">
    <bezierControls>
...
```doenet-example
<graph size="small">
  <shortDescription>A graph of a curve with some hidden control vectors</shortDescription>
  <curve name="curve1" through="(1,5) (-3,-6) (1,0) (-6,3)">
    <bezierControls>
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a curve with bezier control points</shortDescription>
  <curve 
    name="curve1" 
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a curve with x and y critical points highlighted</shortDescription>
  <curve 
    name="curve1" 
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a curve with curvature change points highlighted</shortDescription>
  <curve 
    name="curve1" 
    through="(-2,6) (0,0) (1,1) (-6,3)">
    <bezierControls>
