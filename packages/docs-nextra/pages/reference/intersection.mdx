...
<ComponentDisplay name='intersection'/>

`<intersection>{:dn}` is a [Graphical](../concepts/essentialConcepts#component-types)
...
<graph size="small">
  <shortDescription>graph showing the intersection of two lines</shortDescription>
...
<graph size="small">
  <shortDescription>graph showing the intersections of a line and a pentagon</shortDescription>
  <line name="line1">y = x</line>
  <regularPolygon 
    name="pentagon" 
    numSides="5" 
...
<graph size="small">
  <shortDescription>graph showing the intersections of a polyline and a circle</shortDescription>
...
<graph size="small">
  <shortDescription>graph showing a line and a circle that may or may not intersect</shortDescription>
...
<graph size="small">
  <shortDescription>graph showing two lines whose slopes can be made equal</shortDescription>
  <line name="line1">y = x</line>
...
<graph size="small">
  <shortDescription>graph showing intersections of a vertical line with a rectangle</shortDescription>
...
<graph size="small">
  <shortDescription>graph showing intersections of a line and a rectangle with a styled point</shortDescription>
  <line name="line1">y = x</line>
