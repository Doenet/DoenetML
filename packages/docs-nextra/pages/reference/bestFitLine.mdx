...
<ComponentDisplay name='bestFitLine'/>

`<bestFitLine>{:dn}` is a [Graphical](../concepts/essentialConcepts#component-types) 
...
```doenet-example
 <graph size="small">
    <shortDescription>A graph of a best fit line through three draggable points</shortDescription>
...
```doenet-example
 <p>Enter 3 points:
   <mathInput name="input1"><shortDescription>First point</shortDescription></mathInput>,
   <mathInput name="input2"><shortDescription>Second point</shortDescription></mathInput>,
   <mathInput name="input3"><shortDescription>Third point</shortDescription></mathInput>
 </p>
  ...
  <graph size="small">
    <shortDescription>A graph of a best fit line through three user-entered points</shortDescription>
    <bestFitLine data="$p1 $p2 $p3"/>
    $p1 
    $p2
    $p3
...
```doenet-editor-horiz
 <p>Add your data points to the graph, approximated to the nearest <m>0.5</m> units.</p>
  ...
  <graph name="dataGraph" grid>
    <shortDescription>A graph of a best fit line through user-added data points</shortDescription>
...
```doenet-example
 <graph size="small">
    <shortDescription>A graph of a best fit line through three points</shortDescription>
...
```doenet-example
<graph size="small">
  <shortDescription>A graph of a best fit line with custom variable names</shortDescription>
...
```doenet-example
<graph size="small">
  <shortDescription>A graph of a best fit line and its data points</shortDescription>
  <bestFitLine name="line1" data="(-6,-4) (-2,0) (5,3)"/>
