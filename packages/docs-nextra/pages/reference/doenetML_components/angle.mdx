...
## What it does
`<angle>` renders a geometric angle when nested inside a `<graph>` component. It is both a [Graphical Component](../componentClasses), as well as a [Math](../componentClasses). 
