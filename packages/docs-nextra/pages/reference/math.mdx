...
<ComponentDisplay name='math'/>

`<math>{:dn}` is a [Math](../concepts/essentialConcepts#component-types)
...
```doenet-editor-horiz
<p><mathInput name="userTest"><label>Type the expression <m>3,2,1</m></label></mathInput>
</p>
