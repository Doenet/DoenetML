...
<ComponentDisplay name='piecewiseFunction'/>

`<piecewiseFunction>{:dn}` is a [Graphical](../concepts/essentialConcepts#component-types)
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a three-part piecewise function</shortDescription>
...
<graph xmin="-2" xmax="2" ymin="-1" ymax="2">
  <shortDescription>A graph of the Heaviside step function with endpoints</shortDescription>
  $H
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a piecewise function with overlapping domains</shortDescription>
...
```doenet-example
<graph>
<shortDescription>A graph of a piecewise function on a restricted domain</shortDescription>
<piecewiseFunction 
  name="f" 
  domain="(-5,5)">
...
<p><m>f(t) = $f</m></p>
<graph>
<shortDescription>A graph of a piecewise function with variable t</shortDescription>
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A graph of a piecewise function with maxima and minima marked</shortDescription>
