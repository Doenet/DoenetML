...
The $y$-coordinate of the point is defined with the function evaluation macro &dollar;&dollar; $f(x)$.
...
### Example: currentAnimationDirection
```doenet-example
