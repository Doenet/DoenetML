...
<ComponentDisplay name='animateFromSequence'/>

`<animateFromSequence/>{:dn}` is a [General Operator](../concepts/essentialConcepts#component-types) component
...
```doenet-example
<graph size="small">
  <shortDescription>A circle with animated radius</shortDescription>
...
```doenet-editor-horiz
<graph size="small">
  <shortDescription>A function with an animated point moving along it</shortDescription>
...
```doenet-example
<graph size="small">
  <shortDescription>A graph with a point whose x-coordinate is animated</shortDescription>
...
<booleanInput name="switch"><label>Click to animate</label></booleanInput> $switch
...
<p><textInput name="userMode" prefill="increase"><label>Type "increase", "increase once", "decrease", "decrease once", or "oscillate"</label></textInput></p>
...
<sideBySide>
<stack>
<p><mathInput name="miA" prefill="500"><label>Point A</label></mathInput></p> 
<p><mathInput name="miB" prefill="800"><label>Point B</label></mathInput></p>
</stack>

<graph size="small">
  <shortDescription>A graph with two points whose y-coordinates are animated</shortDescription>
