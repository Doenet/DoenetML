...
```doenet-example
 <tabular topBorder="minor" bottomBorder="minor">
    <row>
      <cell halign="end"><c>xmin=</c></cell>
      <cell halign="start"><mathInput name="xMin" prefill="-1" /></cell>
      <cell halign="end"><c>xmax</c></cell>
      <cell halign="start"><mathInput name="xMax" prefill="6" /></cell>
      <cell halign="end"><c>grid</c></cell>
      <cell halign="start"><booleanInput name="showGrid" /></cell>
    </row>
    <row>
      <cell halign="end"><c>ymin=</c></cell>
      <cell halign="start"><mathInput name="yMin" prefill="-2" /></cell>
      <cell halign="end"><c>ymax</c></cell>
      <cell halign="start"><mathInput name="yMax" prefill="10" /></cell>
      <cell halign="end"><c>fix axes</c></cell>
      <cell halign="start"><booleanInput name="fixAxes" prefill="false" /></cell>
    </row>
    <row>
      <cell halign="end"><c>size</c></cell>
      <cell halign="start">
      ...
      <cell halign="end"><c>align</c></cell>
      <cell halign="start">
      ...
      <cell halign="end"><c>border</c></cell>
      <cell halign="start"><booleanInput name="showBorder" prefill="true" /></cell>  
    </row>
  </tabular>
