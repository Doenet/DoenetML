...
*Insert screenshot here pointing to sign-in button*
...
*Insert login screenshot after button click*
...
*Insert homepage screenshot pointing to portfolio*

At first your portfolio will be empty, but you can click on "Add Activity" to create a document.

*Insert portfolio screenshot pointing to add activity button*
...
*Insert screenshot of top of editor*
...
*Insert screenshot showing checkbox to make public*
