...
<ComponentDisplay name='attractToGrid'/>

`<attractToGrid>{:dn}` is a [Graphical](../concepts/essentialConcepts#component-types) component that 
is used within a `<point>{:dn}` to attract it to a specified grid.
