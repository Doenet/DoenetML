...
<ComponentDisplay name='constrainTo'/>

`<constrainTo>{:dn}` is a [Graphical](../concepts/essentialConcepts#component-types) component
...
<graph size="small"><shortDescription>A graph of a line and a circle</shortDescription>
...
<graph size="small"><shortDescription>A graph of a function and a tangent line</shortDescription>
