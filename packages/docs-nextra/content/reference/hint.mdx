...
<ComponentDisplay name='hint'/>

`<hint>{:dn}` is a [Sectional](../concepts/essentialConcepts#component-types)
...
<p>
  <answer>
    <label>What food item below was NOT invented in America?</label>
...
```doenet-editor-horiz
<p>
  <answer name="ans1"><label>What is the smallest prime number?</label>2</answer>
    <hint hide="$ans1 != 1">
...
```doenet-editor-horiz
<p>
  <answer name="ans"><label>Given the line <math>y = 1/2 x - 4</math>, what is the <m>y</m>-intercept?</label>-4</answer>
