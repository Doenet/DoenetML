...
<ComponentDisplay name='odeSystem'/>
...
```doenet-editor-horiz
<p><mathInput name="ivar" prefill="t"><label>Enter independent variable</label></mathInput></p>
<p><mathInput name="dvar" prefill="x"><label>Enter dependent variable</label></mathInput></p>
<p><mathInput name="ic" prefill="1"><label>Enter initial condition, <m>$dvar(0) = </m></label></mathInput></p>
<p><mathInput name="rhs" prefill="$dvar"><label>Enter the equation's right-hand side, <m>\frac{d $dvar}{d $ivar} = </m></label></mathInput></p>
...
<graph>
  <shortDescription>A graph of the numerical solution to the ODE</shortDescription>
...
```doenet-editor-horiz
<p>A ball weighing <mathInput name="wt" prefill="128"><shortDescription>ball weight in pounds</shortDescription></mathInput> pounds is suspended from a spring. The spring, with constant <m>k = </m><mathInput name="k" prefill="64"><shortDescription>spring constant</shortDescription></mathInput> <m>\frac{\text{lb}}{\text{ft}}</m> stretches <mathInput name="s1" prefill="2"><shortDescription>initial stretch in feet</shortDescription></mathInput> feet from its initial, unweighted length. The ball is then placed in motion by compressing the spring <mathInput name="s2" prefill="-0.5"><shortDescription>compression in feet</shortDescription></mathInput> feet <em>upwards</em> from equilibrium, and then released.</p>
<p>Find the vertical position of the ball at time <m>t = </m> <mathInput name="t" prefill="pi/12"><shortDescription>time in seconds</shortDescription></mathInput> seconds.<footnote>Adapted from: Bronson, R. (1988). Chapter 11. In 2500 solved problems in differential equations (p. 255). McGraw-Hill. </footnote></p>
...
<p><answer><label><m>x($t) = </m></label>$$springMass.numericalSolution[1]($t)</answer></p>
...
<p>Simulation</p>
  <graph displayXaxis="false" displayYaxis="false" xmin="-1" xmax="1" ymin="-1" ymax="1" fixAxes>
    <shortDescription>An animated pendulum simulation</shortDescription>
...
<graph xmax="pi" xmin="-pi" fixAxes>
  <shortDescription>Phase plane of the pendulum's angle and angular velocity</shortDescription>
...
<graph xmin="-1.1" xmax="10" ymin="-pi" ymax="pi" fixAxes>
  <shortDescription>Pendulum's angle as a function of time</shortDescription>
  <xLabel><m>t</m></xLabel>
...
```doenet-editor-horiz
<p><mathInput name="t0" prefill="0"><label><m>t_0 = </m></label></mathInput></p>
<p><mathInput name="tf" prefill="10"><label><m>t_f = </m></label></mathInput></p>
...
<p><mathInput name="t" prefill="10"><label>t</label></mathInput></p>
<p>
  <mathInput name="tol" parseScientificNotation prefill="1E-6"><label>tolerance</label></mathInput>
  <em>(default = <m>0.000001</m>)</em>
</p>
<p><mathInput name="maxIter" prefill="1000"><label>maxIterations</label></mathInput>
  <em>(default = <m>1000</m>)</em>
</p>
<p><slider name="chunkSize" initialValue="10" from="1" to="100"><label>chunkSize</label></slider> 
...
<p>
  <answer allowedErrorInNumbers="$tol">
    <label>Check if tolerance achieved</label>
...
<p><mathInput name="chunkSize" prefill="10"><label>chunkSize</label></mathInput>
  <em>(default = <m>10</m>)</em>
</p>
<odeSystem name="ode" initialConditions="1" maxIterations="$maxIter" tolerance="$tol" chunkSize="$chunkSize">
  <rightHandSide>x</rightHandSide>
...
<p>
  <answer><label><m>x(0) = </m></label>$ode.initialConditions</answer>
</p>
...
<p><mathInput name="ic1" prefill="0"><label><m>x(0) = </m></label></mathInput></p>
<p><mathInput name="ic2" prefill="1"><label><m>y(0) = </m></label></mathInput></p>
...
<p><mathInput name="t"><label><m>t = </m></label></mathInput></p>
