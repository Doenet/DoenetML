...
<p>
  <answer>
    <label>What is <m>(1,2,3)+(4,5,6)</m>?</label>
...
<p>
  <answer>
    <label>Enter anything mathematically equivalent to <m>x^2+2x+1</m></label>
    <award>x^2+2x+1</award>
  </answer></p>

<p>
  <answer>
    <label>Enter <m>x^2+2x+1</m> exactly</label>
    <award symbolicEquality>x^2+2x+1</award>
  </answer></p>

<p>
  <answer>
    <label>Enter <m>x^2+2x+1</m> or some mathematically equivalent forms (not factored)</label>
    <award symbolicEquality simplifyOnCompare>x^2+2x+1</award>
  </answer></p>

<p>
  <choiceInput name="simpOnComp" inline preselectChoice="1">
    <label>Pick a level of simplification</label>
    <choice>none</choice>
...
<p>
  <answer>
    <label>Enter <m>x^2+2x+1</m></label>
...
<p>
  <answer>
    <label>Enter <m>x^2+2x+1</m> in factored or unfactored form</label>
