...
The following examples illustrate use of the `<answer>{:dn}` tag attributes (Part 2).
...
```doenet-example
<answer maxNumAttempts="2" symbolicEquality><label><m>\sqrt{529} = </m></label>23</answer>
```
...
```doenet-example
<p>
  <answer allowedErrorInNumbers="0.01"><label>Enter a number within about <m>1\%</m> of <m>100</m></label>100</answer>
</p>
<p>
  <answer allowedErrorInNumbers="0.01" allowedErrorIsAbsolute><label>Enter a number within 0.01 of <m>100</m></label>100</answer>
</p>
<p>
  <answer allowedErrorInNumbers="0.1" symbolicEquality><label>Enter an expression close to <m>\sin(\pi x)</m></label>sin(pi x)</answer>
</p>
```
...
```doenet-example
<p>
  <answer allowedErrorInNumbers="1" allowedErrorIsAbsolute><label>Enter a number within <m>1</m> of <m>100</m></label>100</answer></p>

<p>
  <answer allowedErrorInNumbers="10" allowedErrorIsAbsolute><label>Enter a number within <m>10</m> of <m>100</m></label>100</answer></p>
```
...
```doenet-example
  <p>
  <answer allowedErrorInNumbers="0.01" symbolicEquality><label>Allow a 1% error in <m>2x^3+4</m>, but only in the coefficient 2 and constant 4</label>2x^3+4</answer>
  </p>

    <p>
  <answer allowedErrorInNumbers="0.01" symbolicEquality includeErrorInNumberExponents><label>Allow a 1% error in <m>2x^3+4</m>, in any of the 3 numbers</label>2x^3+4</answer>
  </p>
```
...
```doenet-example
<p><answer type="text"><label>Enter tTkLp</label>tTkLp</answer></p>
<p>
  <answer type="text" caseInsensitiveMatch><label>Enter tTkLp with any capitalization</label>ttklp</answer>
</p>

<p>
  <answer caseInsensitiveMatch><label>Either <m>x^2</m> or <m>X^2</m> is acceptable</label>x^2</answer>
</p>
```
...
```doenet-example
<answer name="ans1" showCorrectness="false" symbolicEquality><label><m>\sqrt{529} = </m></label>23</answer> 
...
### Example: type="text"
```doenet-example
<p><answer type="text"><label>Enter <em>hello</em></label>hello</answer></p>
```
...
<answer disableAfterCorrect>
  <choiceInput>
    <label>Given an angle <m>\theta</m> on the unit circle, what 
    is the name for the ratio of the opposite side to the hypotenuse?</label>
...
```doenet-example
<answer shuffleOrder>
  <label>Select the smallest number</label>
...
<answer splitSymbols="false">
  <label>Enter the product of the variables <c>two</c> and <c>vars</c></label>
...
<p>
  <answer name="ans" 
    ...
    >
    <label>Enter the value of <m>\pi</m> to at least 2 decimal places.</label>
    3.141592653589793
  </answer>
</p>
...
<p>
  <answer name="ans" displayDigitsForCreditAchieved="6">
    <label>Enter <m>x</m> for full credit, <m>y</m> for partial credit.</label>
    <award>x</award>
...
```doenet-example
<p>
  <answer name="ans" matchBlanks><label>Enter <m>f()</m> with no arguments.</label>f()</answer>
</p>
```
