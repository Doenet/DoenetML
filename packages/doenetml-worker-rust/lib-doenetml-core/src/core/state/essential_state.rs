...
pub enum EssentialDataOrigin {
    /// Essential data was generated because a prop make a preliminary value data query
    ...
    /// Essential data was generated for a prop because a component did not have children.
    ///
    ...
    /// Essential data was generated for a prop because an attribute did not have children.
    ///
    /// Unnamed `usize` field is the index of the prop requesting the children.
