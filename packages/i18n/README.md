...
catalog naming a `numberingSystem` on a Fluent builtin, a
...
in `0`–`9` — even under a locale CLDR counts in another script, which today is
Bangla, Assamese, Marathi, Nepali, Burmese, Persian, Pashto and Sindhi.
