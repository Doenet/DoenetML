...
subset-add-remove-points = Ližiä/poista pisteitä
subset-toggle-points-intervals = Vaihta pisteijen ta välien välillä
...
summary-statistics-caption = Yhtehvetotunnusluvut: { $column }
