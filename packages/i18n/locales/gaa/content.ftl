...
# form of the sentence they add up to: **a region says nothing about
# agreement.** Accra and Tamale are in one country and one school system, and
# `locales/dag` writes a class table where this file writes none.
#
