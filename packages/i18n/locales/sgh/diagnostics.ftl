# Shughni (Шугнонӣ, х̌уг̌нӯн зивод) diagnostics: the errors and warnings shown
# to whoever is looking at the screen. Translated from
...
# own source.
#
# **Orthography.** Cyrillic, in the Gorno-Badakhshan practice: Tajik Cyrillic
# as the base, with the Pamiri letters where a Shughni word needs them. Shughni
# is also written in **Latin** and in **Arabic script**, chiefly in
# Afghanistan; a corrector may convert this locale to either, but must convert
# all four files together and must never mix scripts within them.
#
# ## Say plainly what this file is
#
# Shughni has no written register for compiler diagnostics. There is no school
# subject, no manual and no body of technical prose in the language to draw the
# vocabulary from; a Shughni speaker who reads an error message reads it in
# **Tajik** or in **Russian**. This catalog therefore keeps that loan register
# rather than inventing a Shughni one: the wording below is **Tajik almost
# throughout**, with the Russian internationalisms Tajik itself uses
# (`компонент`, `функсия`, `интервал`, `координата`, `матрица`, `вектор`,
# `формат`, `параметр`). Only the conjunctions are Shughni — `ат` for "and" and
# `йо` for "or" — which is exactly how much of this file this seed can honestly
# claim. It is a usable frame; it is not yet Shughni prose, and a speaker
# should overwrite it freely.
#
# ## Number
#
# CLDR ships no plural rules and no display name for `sgh`, so
# `Intl.PluralRules` falls back to the runtime default and only `one` and
# `other` are reachable. Shughni does not mark a noun for number after a
# numeral, so both branches of every selection here are written identically —
# they differ only in the number they print. `[0]` and other numeric literals
# are matched against the value itself and are kept as English has them.
#
# ## Affixes on values
#
# Where a sentence needs a case or izafat ending on a DoenetML identifier, it
# is written hyphenated after the Latin script — `{ $component }-ро`,
# `{ $type }-и` — as Tajik does, and the ending has one form whatever the
# identifier turns out to be, so nothing here depends on the value. No ending
# is ever welded onto an author's own word: a quoted-back word stands inside
# its quotes and the ending falls on a word this catalog wrote. See "An affix
# cannot be welded to a placeable" in the README.
...
line-segment-attributes-ignored-with-endpoint-and-midpoint =
    { $attributesCount ->
        [one] вақте ки ҳам нуқтаи канорӣ ат ҳам нуқтаи миёна дода шудаанд, { $attributes } ба эътибор гирифта намешавад
       *[other] вақте ки ҳам нуқтаи канорӣ ат ҳам нуқтаи миёна дода шудаанд, { $attributes } ба эътибор гирифта намешавад
    }
...
line-equation-invalid-format = Формати нодурусти муодилаи хат дар тағйирёбандаҳои { $variable1 } ат { $variable2 }.

## `<ray>`

ray-overprescribed-through = Шуоъ бо through, endpoint ат direction дода шудааст. through-и додашуда ба эътибор гирифта намешавад.

ray-dimension-mismatch = дар шуоъ numDimensions мувофиқат намекунад.

## `<vector>`

vector-overprescribed-head = Вектор бо head, tail ат displacement дода шудааст. head-и додашуда ба эътибор гирифта намешавад.
...
invalid-type-defaulting-to-math = Навъи нодуруст { $type } барои ҷузъи { $component }. Он бояд math, text, number йо boolean бошад. math истифода мешавад.
...
label-for-must-reference-input-or-answer = Атрибути `for`-и `<label>` бояд ба майдони воридкунӣ йо ба ҷавоб ишора кунад.

## Accessibility

accessibility-short-description-or-decorative = Барои дастрасӣ `<{ $component }>` бояд йо тавсифи кӯтоҳ дошта бошад, йо ҳамчун ороишӣ нишон дода шавад.

accessibility-video-short-description = Барои дастрасӣ `<video>` бояд тавсифи кӯтоҳ дошта бошад.

accessibility-input-short-description-or-label = Барои дастрасӣ `<{ $component }>` бояд тавсифи кӯтоҳ йо нишона дошта бошад.

accessibility-answer-input-short-description-or-label = Барои дастрасӣ `<answer>`-и майдони воридкунӣ созанда бояд тавсифи кӯтоҳ йо нишона дошта бошад.
...
circle-overprescribed-radius-center-points = Доираро бо радиус, марказ ат нуқтаҳои додашуда ҳисоб кардан мумкин нест.
...
circle-invalid-center-or-through-points = Маркази доира йо нуқтаҳои он нодурустанд.
...
function-iterates-input-output-mismatch =
    { $inputs ->
        [one] Такрори функсия танҳо вақте имконпазир аст, ки шумораи вурудҳо ба шумораи хуруҷҳо баробар бошад. Ин функсия { $inputs } вуруд ат { $outputs ->
            [one] { $outputs } хуруҷ
           *[other] { $outputs } хуруҷ
        } дорад.
       *[other] Такрори функсия танҳо вақте имконпазир аст, ки шумораи вурудҳо ба шумораи хуруҷҳо баробар бошад. Ин функсия { $inputs } вуруд ат { $outputs ->
            [one] { $outputs } хуруҷ
           *[other] { $outputs } хуруҷ
        } дорад.
    }
...
ionic-compound-needs-cation-and-anion = Пайвастагиҳои ионӣ танҳо барои як катион ат як анион амалӣ карда шудаанд.
...
graph-grid-invalid = `<graph>`: grid="{ $grid }"-ро шарҳ додан мумкин нест. Он бояд none, medium, dense йо ду адади мусбати бо фосила ҷудошуда бошад, масалан grid="1 0.5". Тӯр кашида намешавад.
...
copy-unrecognized-component-type = Навъи ношиноси ҷузъро васеъ йо нусхабардорӣ кардан мумкин нест: { $type }.
...
conditional-content-condition-ignored = Атрибути `condition` дар ҷузъи `<conditionalContent>`-и дорои фарзандони case йо else ба эътибор гирифта намешавад.

slider-markers-type-mismatch = Навъи маркерҳо ба навъи лағжанда мувофиқат намекунад.

pretzel-problem-needs-statement-and-answer = pretzel-и нодуруст: ҳар `<problem>` бояд як `<statement>` ат як `<answer>` дошта бошад.
...
math-input-invalid-function-names = <mathInput>: номҳои нодурусти функсия дар { $attribute } ба эътибор гирифта нашуданд: { $names }. Қисми намоёни ҳар ном бояд ҳадди ақал 2 аломат бошад (ҳарфҳо йо тиреҳо); пас аз он пасванди ихтиёрии `|<mathspeak алтернатива>` омада метавонад.
...
style-definition-dark-mode-text-background-contrast =
    Ҳарчанд рангҳои дар таърифи услуби { $styleNumber } додашуда барои реҷаи равшан контрасти кофӣ медиҳанд, рангҳои реҷаи торики аз онҳо ҳосилшуда байни матн ат замина контрасти нокофӣ медиҳанд ({ NUMBER($ratio, minimumFractionDigits: 2, maximumFractionDigits: 2) }:1; ҳадди ақал { $threshold }:1 лозим аст). { $suggestion ->
        [available] Барои контрасти кофӣ дар реҷаи торик йо контрастро дар реҷаи равшан зиёд кунед (масалан { $lightAttribute }="{ $lightColor }"), йо ранги реҷаи торикро иваз кунед (масалан { $darkAttribute }="{ $darkColor }").
       *[none] Барои контрасти кофӣ дар реҷаи торик контрастро дар реҷаи равшан зиёд кунед йо рангҳои ҳосилшударо бо textColorDarkMode ат/йо backgroundColorDarkMode иваз кунед.
    }
...
style-definition-dark-mode-text-canvas-contrast =
    Ҳарчанд ранги матни дар таърифи услуби { $styleNumber } додашуда барои реҷаи равшан контрасти кофӣ медиҳад, ранги матни реҷаи торики аз он ҳосилшуда нисбат ба майдони расм контрасти нокофӣ медиҳад ({ NUMBER($ratio, minimumFractionDigits: 2, maximumFractionDigits: 2) }:1; ҳадди ақал { $threshold }:1 лозим аст). { $suggestion ->
        [available] Барои контрасти кофӣ дар реҷаи торик йо контрастро дар реҷаи равшан зиёд кунед (масалан textColor="{ $lightColor }"), йо ранги реҷаи торикро иваз кунед (масалан textColorDarkMode="{ $darkColor }").
       *[none] Барои контрасти кофӣ дар реҷаи торик контрастро дар реҷаи равшан зиёд кунед йо ранги ҳосилшударо бо textColorDarkMode иваз кунед.
    }
...
variant-select-weight-disables-unique = агар ягон интихоб selectWeight йо selectForVariants дошта бошад, вариантҳои беназири select хомӯш карда мешаванд
...
prefigure-descendant-invalid-geometry = { $subject }: геометрияи беохир йо нопурра; ворис партофта шуд.
...
annotation-text-missing = `<annotation>`: `text` нест йо холӣ аст; матни холӣ бароварда мешавад.
...
parse-tag-missing-close-tag = DoenetML-и нодуруст: теги `{ $tag }` теги пӯшанда надорад. Теги худпӯшанда йо теги `</{ $tagName }>` интизор мешуд.
...
name-attribute-invalid =
    Атрибути нодуруст name='{ $name }'. { $reason ->
        [characters] Номҳо танҳо метавонанд ҳарфҳо, рақамҳо, зерхатҳо йо тиреҳо дошта бошанд.
...
deprecated-attribute-renamed-conflict =
    { $component ->
        [none] [deprecation] Атрибути `{ $from }` кӯҳна шудааст ат ба эътибор гирифта намешавад, зеро `{ $to }` низ дода шудааст.
       *[other] [deprecation] Атрибути `{ $from }`-и `<{ $component }>` кӯҳна шудааст ат ба эътибор гирифта намешавад, зеро `{ $to }` низ дода шудааст.
    }

deprecated-attribute-ignored = [deprecation] Атрибути `{ $attribute }`-и `<{ $component }>` кӯҳна шудааст ат ба эътибор гирифта намешавад.


## Language coverage

pluralize-english-only = `<pluralize>` танҳо дар забони англисӣ ҷамъбандӣ карда метавонад, бинобар ин дар ҳуҷҷати бо забони { $locale } навишташуда матни он бетағйир мемонад. Шакли ҷамъро худатон нависед йо онро бо атрибути `pluralForm` таъин кунед.
...
select-from-sequence-coprime-common-factor = Ададҳои ҷуфти содаро интихоб кардан мумкин нест. Ҳамаи қиматҳои имконпазир бахшкунандаи умумӣ доранд. (Қиматҳои додашудаи "from" йо "to" бояд бо "step" ҷуфти сода бошанд.)
...
## Keys `locales/tg` had not covered

field-function-wrong-num-outputs =
    `<{ $component }>` ба функсияе ниёз дорад, ки { $expected ->
        [one] як натиҷа диҳад — нишебии y' дар ҳар нуқта, мисли `y - x`
       *[other] ду натиҷа диҳад — вектор дар ҳар нуқта, мисли `(y, -x)`
    }, аммо функсияи додашуда { $found ->
        [one] { $found } натиҷа дорад
       *[other] { $found } натиҷа дорад
    }. { $alternative ->
        [none] Чизе кашида намешавад.
       *[other] Барои чунин функсия компоненти `<{ $alternative }>` аст. Чизе кашида намешавад.
    }

field-function-attribute-ignored-with-child = Атрибути `function` ба эътибор гирифта намешавад, зеро функсия дар дохили компонент ҳам дода шудааст; ҳамон дохилӣ истифода мешавад. Функсияро танҳо бо як роҳ диҳед.

field-variables-ignored =
    `<{ $component }>`: атрибути `variables` тағйирёбандаҳои ифодаеро ном мебарад, ки бевосита дар дохили компонент навишта шудааст. { $reason ->
        [function-child] Ин ҷо функсия ҳамчун фарзанди `<function>` дода шудааст ва он тағйирёбандаҳои худро худаш ном мебарад, бинобар ин `variables` ба эътибор гирифта намешавад.
       *[no-expression] Ин ҷо чунин ифода дода нашудааст, бинобар ин `variables` ба эътибор гирифта намешавад.
    }

deprecated-attribute-to-child = [deprecation] Атрибути `{ $attribute }` дар `<{ $component }>` кӯҳна шудааст; ба ҷои он фарзанди `<{ $child }>`-ро истифода баред.

deprecated-attribute-value-renamed = [deprecation] Қимати `{ $value }`-и атрибути `{ $attribute }` дар `<{ $component }>` кӯҳна шудааст; ба ҷои он `{ $to }`-ро истифода баред.

math-embedded-input-shape-unsuitable =
    `<{ $component }>` дар дохили математика кашида намешавад; ифода ҳамон тавре чоп мешавад, ки пеш аз имкони ҷойгиркунии майдонҳо буд. { $reason ->
        [not-inline] Танҳо интихоби `inline` дар дохили ифода мегунҷад; бе `inline` он блоки тугмаҳо мешавад.
        [expanded] Майдони матнии `expanded` қуттии бисёрсатрӣ аст ат барои дохили ифода хеле калон аст.
        [on-graph] Дар график ифода ҳамчун як расми ягона кашида мешавад ат дар он ҷо барои идора ҷой нест.
       *[relative-width] Бари он нисбӣ аст (фоиз йо `em`) ат дар дохили ифода чизе барои чен кардан нест. Барро дар воҳидҳои мутлақ, мисли `px`, диҳед.
    }
