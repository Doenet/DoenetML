...
core-start-failed-busy = Dokumentin kattelinta ei voitu käynistää. Monta dokumenttia käynisty yhtä aikaa, mikä saattaa kestää kauemin hitaamala laittheela. Sivun uuelleenlataus saattaa auttaa, ko muut dokumentit oon valmhiit.
core-start-failed-retry = Dokumentin kattelinta ei voitu käynistää.
core-start-failed-busy-retry = Dokumentin kattelinta ei voitu käynistää. Monta dokumenttia käynisty yhtä aikaa, mikä saattaa kestää kauemin hitaamala laittheela.
core-start-retry = Kokeile uuelleen
saved-state-unavailable = Sinun tallenettua työtä ei voitu ladata.
