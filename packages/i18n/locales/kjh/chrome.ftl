...
accessibility-heading-level-1 = WCAG AA тузаланҷаң арғаның тоғыр полғаны
accessibility-heading-level-2 = Тузаланҷаң арға тузында сағындырығ
something-went-wrong = Ноо-да ниме тоғыр полған.
renderer-load-failed = кӧзідҷең ниме тартылбаан. Страницаны хатап тартыңар.
