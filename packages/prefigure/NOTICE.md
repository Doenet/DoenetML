...
This package is distributed by Doenet as part of the DoenetML project and is
...
licensing terms, along with any modifications made in DoenetML.

Doenet-specific work in this package includes the standalone package structure,
CDN/browser packaging, build integration, publication workflow, wheel-sync
checks, runtime initialization flow, and downstream integration with DoenetML.