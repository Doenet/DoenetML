...
describe("Collect Tag Tests", function () {
    ...
    `,
        ...
        cy.get(cesc("#\\/length") + " textarea").type(
        ...
        cy.get(cesc("#\\/mult") + " textarea").type(
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let collect1Replacements =
                stateVariables["/pcollect1"].activeChildren;
            let collect2Replacements =
                stateVariables["/pcollect2"].activeChildren;
            let group2Replacements = stateVariables["/pgroup2"].activeChildren;
            let collect3Replacements =
                stateVariables["/pcollect3"].activeChildren;
    ...
    `,
        ...
        function checkAllChildren(stateVariables) {
            ...
            if (collect.replacementsToWithhold) {
                nActiveReps -=
                    stateVariables["/_collect1"].replacementsToWithhold;
            }
