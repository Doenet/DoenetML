...
describe("Curve Tag Bezier Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let v00 =
                stateVariables["/_curve1"].stateValues.controlVectors[1][0][0];
            let v01 =
                stateVariables["/_curve1"].stateValues.controlVectors[1][0][1];
            expect(v00).not.eq(4);
            expect(v01).not.eq(-2);
            expect(
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let cv2 =
                stateVariables["/_curve1"].stateValues.controlVectors[1][0];
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            let cv3 =
                stateVariables["/_curve1"].stateValues.controlVectors[2][0];
