...
describe("Ion Tests", function () {
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            let mathinputClName =
                stateVariables["/ansCl"].stateValues.inputChildren[0]
                    .componentName;
            ...
            let mathinputHName =
                stateVariables["/ansH"].stateValues.inputChildren[0]
                    .componentName;
            ...
            let mathinputMgName =
                stateVariables["/ansMg"].stateValues.inputChildren[0]
                    .componentName;
            ...
            let mathinputPName =
                stateVariables["/ansP"].stateValues.inputChildren[0]
                    .componentName;
            ...
            let mathinputSName =
                stateVariables["/ansS"].stateValues.inputChildren[0]
                    .componentName;
