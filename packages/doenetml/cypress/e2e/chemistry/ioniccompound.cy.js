  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            let mathinputLiOName =
                stateVariables["/ansLiO"].stateValues.inputChildren[0]
                    .componentName;
            ...
            cy.get(mathinputLiOAnchor).type(
            ...
            let mathinputCaPName =
                stateVariables["/ansCaP"].stateValues.inputChildren[0]
                    .componentName;
            ...
            cy.get(mathinputCaPAnchor).type("{ctrl+end}_2{enter}", {
                force: true,
            });
            cy.get(mathinputCaPCorrectAnchor).should("be.visible");

            let mathinputMgSName =
                stateVariables["/ansMgS"].stateValues.inputChildren[0]
                    .componentName;
            ...
            let mathinputSrIName =
                stateVariables["/ansSrI"].stateValues.inputChildren[0]
                    .componentName;
