...
// console.log(TAD)
// const tad = await import.meta.glob("./testActivityDefinition.doenet");
// const tad2 = await tad["./testActivityDefinition.doenet"]();
// console.log(tad2)
// console.log('tad', tad, tad["./testActivityDefinition.doenet"]());
