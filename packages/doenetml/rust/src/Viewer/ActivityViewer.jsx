...
export default function ActivityViewer(props) {
    ...
    const [activityDefinitionFromProps, setActivityDefinitionFromProps] =
        useState(null);
    ...
    async function calculateOrderAndVariants() {
        ...
        let variantIndex =
            ((requestedVariantIndex - 1) %
                activityVariantResult.numberOfVariants) +
            1;
        if (variantIndex < 1) {
        ...
        let allPossibleNonIgnoredPerPage = [],
            indicesToIgnorePerPage = [];
        ...
        if (
            numberOfPageVariantCombinations <=
            activityVariantResult.numberOfVariants
        ) {
            ...
            <div key={`page${ind}`}>
                <PageViewer
                    ...
                    updateCreditAchievedCallback={
                        props.updateCreditAchievedCallback
                    }
    ...
    if (cidChanged) {
        cidChangedAlert = (
            <div>
                <button onClick={() => alert("Hey, content changed")}>
                    content changed
                </button>
            </div>
        );
