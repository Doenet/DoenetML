    ...
    function createPointJXG() {
        ...
        if (SVs.showLabel && SVs.label !== "") {
            ...
            if (SVs.applyStyleToLabel) {
                jsxPointAttributes.label.strokeColor =
                    SVs.selectedStyle.markerColor;
            } else {
        ...
        newShadowPointJXG.on("down", function (e) {
            ...
            shadowPointJXG.current.visProp.fillopacity =
                pointJXG.current.visProp.fillopacity;
            shadowPointJXG.current.visProp.strokeopacity =
    ...
    if (board) {
        if (pointJXG.current === null) {
            ...
            if (
                ...
                pointJXG.current.visProp.size = SVs.selectedStyle.markerSize;
                shadowPointJXG.current.visProp.size =
