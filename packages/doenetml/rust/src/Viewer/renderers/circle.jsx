...
export default React.memo(function Circle(props) {
    ...
    function createCircleJXG() {
        ...
        if (SVs.showLabel && SVs.label !== "") {
            if (SVs.applyStyleToLabel) {
                jsxCircleAttributes.label.strokeColor =
    ...
    if (board) {
        if (!circleJXG.current) {
            ...
            if (
                circleJXG.current.visProp.strokecolor !==
                SVs.selectedStyle.lineColor
            ) {
                circleJXG.current.visProp.strokecolor =
                    SVs.selectedStyle.lineColor;
                circleJXG.current.visProp.highlightstrokecolor =
                    SVs.selectedStyle.lineColor;
            }
            if (
            ...
            if (
                circleJXG.current.visProp.fillcolor !==
                ...
                circleJXG.current.visProp.highlightfillcolor =
                    SVs.selectedStyle.fillColor;
                circleJXG.current.visProp.hasinnerpoints =
