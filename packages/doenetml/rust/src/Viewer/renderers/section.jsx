...
export default React.memo(function Section(props) {
    ...
    switch (SVs.level) {
        case 0:
            heading = (
                <span id={headingId} style={{ fontSize: "2em" }}>
                    {title}
                </span>
            );
            break;
        case 1:
            heading = (
                <span id={headingId} style={{ fontSize: "1.5em" }}>
                    {title}
                </span>
            );
            break;
        case 2:
            heading = (
                <span id={headingId} style={{ fontSize: "1.17em" }}>
                    {title}
                </span>
            );
            break;
        case 3:
            heading = (
                <span id={headingId} style={{ fontSize: "1em" }}>
                    {title}
                </span>
            );
            break;
        case 4:
            heading = (
                <span id={headingId} style={{ fontSize: ".83em" }}>
                    {title}
                </span>
            );
            break;
        case 5:
            heading = (
                <span id={headingId} style={{ fontSize: ".67em" }}>
                    {title}
                </span>
            );
            break;
    ...
    if (SVs.collapsible) {
        ...
        if (SVs.open) {
            innerContent = (
                <div style={{ display: "block", padding: SVs.boxed && "6px" }}>
                    {children}
                    {checkworkComponent}
                </div>
            );
        ...
        default:
            return (
                <VisibilitySensor
                    ...
                    onChange={onChangeVisibility}
                >
                    <section id={name} style={{ margin: "12px 0" }}>
                        {" "}
                        {content}{" "}
                    </section>
                </VisibilitySensor>
