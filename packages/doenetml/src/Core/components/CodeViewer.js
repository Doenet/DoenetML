        ...
        stateVariableDefinitions.locationFromParent = {
            ...
            definition: function ({ dependencyValues }) {
                return {
                    setValue: {
                        locationFromParent:
                            dependencyValues.locationFromParent || null,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.width = {
            ...
            definition: function ({ dependencyValues }) {
                if (dependencyValues.widthAttr) {
                    ...
                    return {
                        setValue: { width: dependencyValues.parentWidth },
                    };
                } else {
                    //Default
        ...
        stateVariableDefinitions.height = {
            ...
            definition: function ({ dependencyValues }) {
                if (dependencyValues.heightAttr) {
                    ...
                    return {
                        setValue: {
                            height: dependencyValues.parentViewerHeight,
                        },
                    };
                } else {
                    //Default
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.codeSource?.length === 1) {
                    codeSourceComponentName =
                        dependencyValues.codeSource[0].absoluteName;
                } else {
            ...
            definition: function ({ dependencyValues }) {
                if (dependencyValues.codeSourceComponentName) {
                    return {
                        setValue: {
                            codeSource:
                                dependencyValues.codeSourceComponentName,
                        },
                    };
