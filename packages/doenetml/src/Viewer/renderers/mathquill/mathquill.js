...
function closest(el, s) {
    var _a, _b;
    if (
        typeof (el === null || el === void 0 ? void 0 : el.closest) ===
        "function"
    ) {
        return el.closest(s);
    }
            ...
            (_b =
                (_a =
                    match === null || match === void 0
                        ? void 0
                        : match.parentElement) !== null && _a !== void 0
                    ? _a
                    : match === null || match === void 0
                      ? void 0
...
var DOMFragment = /** @class */ (function () {
    ...
    DOMFragment.prototype.replaceWith = function (children) {
        var _a;
        var rightEnd =
            (_a = this.ends) === null || _a === void 0 ? void 0 : _a[R];
        ...
        var parent =
            rightEnd === null || rightEnd === void 0
                ? void 0
                : rightEnd.parentNode;
        var nextSibling =
            rightEnd === null || rightEnd === void 0
                ? void 0
                : rightEnd.nextSibling;
        this.detach();
    ...
    DOMFragment.prototype.insDirOf = function (dir, sibling) {
        ...
        if (!this.ends) return this;
        var el =
            (_a = sibling.ends) === null || _a === void 0 ? void 0 : _a[dir];
    ...
    NodeBase.prototype.checkCursorContextOpen = function (ctx) {
        ...
        if (restoreInfo) {
            if (latexLength === restoreInfo.uncleanedStartIndex) {
                if (
                    restoreInfo.uncleanedEndIndex ===
                    restoreInfo.uncleanedStartIndex
                ) {
                    // caret
                    if (latexLength === restoreInfo.uncleanedStartIndex) {
...
var Fragment = /** @class */ (function () {
    ...
    Fragment.prototype.adopt = function (parent, leftward, rightward) {
        ...
        var ends =
            ((_c = {}),
            (_c[L] = parent.getEnd(L)),
            (_c[R] = parent.getEnd(R)),
            _c);
        if (leftward) {
...
function getInterface(v) {
    ...
    var EditableField = /** @class */ (function (_super) {
        ...
        EditableField.prototype.dropEmbedded = function (
            pageX,
            pageY,
            options,
        ) {
    ...
    return function saneKeyboardEvents(
        ...
        function typedText() {
            ...
            if (text.length === 1) {
                ...
                if (
                    controller.options &&
                    controller.options.overrideTypedText
                ) {
        ...
        if (controller.KIND_OF_MQ === "StaticMath") {
            controller.addTextareaEventListeners({
                keydown: function (evt) {
                    ...
                    (_d = (_c = controller.options).overrideKeystroke) ===
                        null || _d === void 0
                        ? void 0
                        : _d.call(_c, getMQKeyName(evt), evt);
                },
            });
        ...
        switch (key) {
            ...
            case "Ctrl-Alt-Up": // speak parent block that has focus
                if (
                    ...
                    cursor.parent.parent instanceof MQNode
                )
    ...
    Controller_keystroke.prototype.deleteDir = function (dir) {
        ...
        if (cursorEl && cursorEl instanceof MQNode) {
            ...
            if (cursorElParent.sides) {
                ...
                cursorElParent.blocks &&
                cursorElParent.mathspeakTemplate
            ) {
...
var Controller_latex = /** @class */ (function (_super) {
    ...
    Controller_latex.prototype.restoreLatexSelection = function (newSelection) {
        ...
        if (newSelection.endIndex === 0) {
            ...
            var mappedIndices = mapFromCleanedToUncleanedIndices(
                oldLatex,
                oldSelectionInfo.ctx.uncleanedLatex,
                newSelection,
            );
            var restoreInfo_1 =
                this.exportLatexSelection(mappedIndices).ctx.restoreInfo;
            if (newSelection.startIndex === newSelection.endIndex) {
                if (
                    restoreInfo_1 === null || restoreInfo_1 === void 0
                        ? void 0
                        : restoreInfo_1.cursorL
                ) {
                ...
                if (
                    (restoreInfo_1 === null || restoreInfo_1 === void 0
                        ? void 0
                        : restoreInfo_1.selectionL) &&
                    restoreInfo_1.selectionR
                ) {
                    ...
                    this.withIncrementalSelection(function (selectDir) {
                        do {
                            ...
                            if (
                                !_this_1.cursor[L] &&
                                _this_1.cursor.parent === root_1
                            ) {
                                break;
                            }
                        } while (
                            _this_1.cursor[R] !== restoreInfo_1.selectionL
                        );
                    });
    ...
    Controller_latex.prototype.exportLatexSelection = function (restoreInfo) {
        ...
        var _c = mapFromUncleanedToCleanedIndices(
                uncleanedLatex,
                cleanLatex,
                ctx,
            ),
    ...
    ControllerBase.onNotify(function (cursor, e) {
        if (e === "edit" || e === "replace") {
            ...
            if (
                ...
                cancelSelectionOnEdit.cursor === cursor
            ) {
    ...
    function Controller_mouse() {
        ...
        _this_1.handleMouseDown = function (e) {
            ...
            function onDocumentMouseMove(e) {
                if (!cursor.anticursor) cursor.startSelection();
                ctrlr
                    .seek(lastMousemoveTarget, e.clientX, e.clientY)
                    .cursor.select();
                if (cursor.selection)
                    cursor.controller.aria
                        .clear()
            ...
            if (ctrlr.blurred) {
                ...
                if (_this_1.editable) textarea.focus();
...
var Controller_scrollHoriz = /** @class */ (function (_super) {
    ...
    Controller_scrollHoriz.prototype.scrollHoriz = function () {
            ...
            animate(
                ...
                function (progress, scheduleNext, cancel) {
                    if (progress >= 1) {
                        ...
                        scheduleNext();
                        rootElt_1.scrollLeft = Math.round(
                            (1 - progress) * start_1,
                        );
                    }
                },
        ...
        if (
            scrollBy > 0 &&
            root.scrollWidth <= root.scrollLeft + rootRect.width
        )
            return;
        if (this.cancelScrollHoriz) {
            this.cancelScrollHoriz();
        ...
        animate(
            ...
            function (progress, scheduleNext, cancel) {
                if (progress >= 1) {
                    ...
                    _this_1.cancelScrollHoriz = cancel;
                    scheduleNext();
                    rootElt.scrollLeft = Math.round(
                        start + progress * scrollBy,
                    );
                }
            },
        );
    ...
    Controller_scrollHoriz.prototype.getScrollAnimationDuration = function () {
        var _c;
        return (_c = this.options.scrollAnimationDuration) !== null &&
            _c !== void 0
            ? _c
            : 100;
    };
...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.setTabindex = function (tabindex) {
        ...
        (_c = this.textarea) === null || _c === void 0
            ? void 0
            : _c.setAttribute("tabindex", "" + tabindex);
        if (tabindex < 0 && this.KIND_OF_MQ === "StaticMath") {
            (_d = this.textarea) === null || _d === void 0
                ? void 0
                : _d.setAttribute("aria-hidden", "true");
        } else {
            (_e = this.textarea) === null || _e === void 0
                ? void 0
                : _e.removeAttribute("aria-hidden");
        }
        if (tabindex >= 0) {
            (_f = this.mathspeakSpan) === null || _f === void 0
                ? void 0
                : _f.setAttribute("aria-hidden", "true");
        } else {
            (_g = this.mathspeakSpan) === null || _g === void 0
                ? void 0
                : _g.removeAttribute("aria-hidden");
        }
    };
    ...
    Controller.prototype.updateMathspeak = function (opts) {
        ...
        var emptyContent = !!(opts === null || opts === void 0
            ? void 0
            : opts.emptyContent); // Set when the focused field has been blurred so alert text is removed when it's no longer needed.
...
var MathBlock = /** @class */ (function (_super) {
    ...
    MathBlock.prototype.seek = function (clientX, cursor) {
        ...
        while (
            clientX < getBoundingClientRect(node.domFrag().oneElement()).left
        )
            node = node[L];
    ...
    MathBlock.prototype.write = function (cursor, ch) {
        ...
        if (!cursor.isTooDeep()) {
            ...
            if (ch === "/") {
                ...
                cursor.controller.aria.alert(
                    cmd.mathspeak({ createdLeftOf: cursor }),
                );
            }
        }
    };
...
API.StaticMath = function (APIClasses) {
    ...
    return (
        (_c = /** @class */ (function (_super) {
            ...
            StaticMath.prototype.__mathquillify = function (
                opts,
                _interfaceVersion,
            ) {
                this.config(opts);
...
API.MathField = function (APIClasses) {
    ...
    return (
        (_c = /** @class */ (function (_super) {
            ...
            MathField.prototype.__mathquillify = function (
                opts,
                interfaceVersion,
            ) {
                this.config(opts);
...
API.InnerMathField = function (APIClasses) {
    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.makeStatic = function () {
            ...
            domFrag(this.__controller.container).removeClass(
                "mq-editable-field",
            );
        };
    ...
    TextBlock.prototype.seek = function (clientX, cursor) {
        ...
        if (!cursor.anticursor) {
            ...
            if (this.anticursorPosition === cursorPosition) {
                ...
                cursor.anticursor = new Anticursor(
                    this,
                    newTextPc[L],
                    newTextPc,
                );
    ...
    RootMathCommand.prototype.createBlocks = function () {
        ...
        endsL.write = function (cursor, ch) {
            if (ch !== "$") MathBlock.prototype.write.call(this, cursor, ch);
                ...
                new VanillaSymbol("\\$", h.text("$")).createLeftOf(
                    cursor.show(),
                );
...
LatexCmds["\u2240"] = LatexCmds.wr = bindVanillaSymbol(
    "\\wr ",
    "&#8768;",
    "wreath",
);
...
LatexCmds["\u226a"] = LatexCmds.ll = bindVanillaSymbol(
    "\\ll ",
    "&#8810;",
    "ll",
);
LatexCmds["\u226b"] = LatexCmds.gg = bindVanillaSymbol(
    "\\gg ",
    "&#8811;",
    "gg",
);
...
LatexCmds["\u2113"] = LatexCmds.ell = bindVanillaSymbol(
    "\\ell ",
    "&#8467;",
    "ell",
);
LatexCmds["\u22a4"] = LatexCmds.top = bindVanillaSymbol(
    "\\top ",
    "&#8868;",
    "top",
);
...
LatexCmds["\u2118"] = LatexCmds.wp = bindVanillaSymbol(
    "\\wp ",
    "&#8472;",
    "wp",
);
LatexCmds["\u22a5"] = LatexCmds.bot = bindVanillaSymbol(
    "\\bot ",
    "&#8869;",
    "bot",
);
...
LatexCmds["\u00a3"] = LatexCmds.pounds = bindVanillaSymbol(
    "\\pounds ",
    "&pound;",
);
LatexCmds["\u2135"] =
...
var Letter = /** @class */ (function (_super) {
    ...
    Letter.prototype.autoParenthesize = function (cursor) {
        ...
        var l = this;
        var i = 0;
        var autoParenthesizedFunctions =
    ...
    Letter.prototype.autoUnItalicize = function (opts) {
        ...
        var rL = r && r[L];
        new Fragment(
            lR || this.parent.getEnd(L),
            rL || this.parent.getEnd(R),
        ).each(function (el) {
        ...
        outer: for (
            ...
            for (
                var len = min(autoOpsLength, str.length - i);
                len > 0;
                len -= 1
            ) {
                ...
                if (autoOps.hasOwnProperty(word)) {
                    ...
                    if (!this.shouldOmitPadding(last[R])) {
                        if (last[R] instanceof SupSub) {
                            ...
                            last.domFrag().toggleClass(
                                "mq-last",
                                !(last[R] instanceof Bracket),
                            );
                        }
                    }
                    i += len - 1;
    ...
    function SymbolWithCustomClass(ch, customClass) {
        return (
            _super.call(
                this,
                ch,
                h("span", { class: customClass }, [h.text(ch)]),
            ) || this
        );
    }
...
LatexCmds[","] = function () {
    return new SymbolWithCustomClass(",", "mq-comma");
};
...
var Inequality = /** @class */ (function (_super) {
    ...
    Inequality.prototype.swap = function (strict) {
        ...
        this.domFrag()
            ...
            .replaceWith(
                domFrag(
                    h.entityText(this.data["htmlEntity".concat(strictness)]),
                ),
            );
...
var SVG_SYMBOLS = {
    sqrt: {
        ...
        html: function () {
            return h(
                "svg",
                { preserveAspectRatio: "none", viewBox: "0 0 32 54" },
                [
                    h("path", {
    ...
    "|": {
        ...
        html: function () {
            return h(
                "svg",
                { preserveAspectRatio: "none", viewBox: "0 0 10 54" },
    ...
    "[": {
        ...
        html: function () {
            return h(
                "svg",
                { preserveAspectRatio: "none", viewBox: "0 0 11 24" },
                [
                    h("path", {
    ...
    "(": {
        ...
        html: function () {
            return h(
                "svg",
                { preserveAspectRatio: "none", viewBox: "3 0 106 186" },
                [
                    h("path", {
...
var Style = /** @class */ (function (_super) {
    ...
    function Style(ctrlSeq, tagName, attrs, ariaLabel, opts) {
                    ...
                    return h.block(tagName, attrs, blocks[0], {
                        ...
                        afterChild:
                            (_d =
                                opts === null || opts === void 0
                                    ? void 0
                                    : opts.afterChild) === null || _d === void 0
                                ? void 0
                                : _d.call(opts),
                    });
                }),
        ...
        _this_1.shouldNotSpeakDelimiters =
            opts && opts.shouldNotSpeakDelimiters;
        return _this_1;
    }
...
LatexCmds.overrightarrow = function () {
    return new Style(
        ...
        {
            afterChild: function () {
                return h("span", { class: "mq-arrow-right-content" }, [
                    h.text(ArrowText),
                ]);
            },
        },
    ...
    return new Style(
        ...
        "Over Left Arrow",
        {
            beforeChild: function () {
                return h("span", { class: "mq-arrow-left-content" }, [
                    h.text(ArrowText),
                ]);
            },
        },
...
LatexCmds.subscript = LatexCmds._ = function () {
    return new SupSub("sub");
};
LatexCmds.superscript =
    LatexCmds.supscript =
    LatexCmds["^"] =
        function () {
            return new SupSub("sup");
        };
...
LatexCmds["\u222b"] =
    ...
    LatexCmds.integral =
        /** @class */ (function (_super) {
            ...
            function class_11() {
                var _this_1 =
                    _super.call(this, "\\int ", "", "integral") || this;
            ...
            FracNode.prototype.mathspeak = function (opts) {
                ...
                if (
                    ...
                    if (newDenSpeech !== "") {
                        ...
                        output +=
                            this.getEnd(L).mathspeak() + " " + newDenSpeech;
                        return output;
                    }
                }
                return _super.prototype.mathspeak.call(this);
            ...
            class_12.prototype.createLeftOf = function (cursor) {
                if (!this.replacedFragment) {
                    ...
                    if (leftward !== cursor[L] && !cursor.isTooDeep(1)) {
                        ...
                        this.replaces(
                            new Fragment(
                                leftwardR || cursor.parent.getEnd(L),
                                cursorL,
                            ),
                        );
                        cursor[L] = leftward;
...
var PercentOfBuilder = function () {
    return new MQSymbol(
        "\\%\\operatorname{of}",
        h("span", { class: "mq-nonSymbola mq-operator-name" }, [
            h.text("% of "),
        ]),
        "percent of",
    );
...
var Bracket = /** @class */ (function (_super) {
    ...
    function Bracket(side, open, close, ctrlSeq, end) {
        var _c;
        var _this_1 =
            _super.call(this, "\\left" + ctrlSeq, undefined, [open, close]) ||
            this;
        _this_1.side = side;
        _this_1.sides =
            ((_c = {}),
    ...
    Bracket.prototype.matchBrack = function (opts, expectedSide, node) {
        ...
        return (
            ...
            (!opts.restrictMismatchedBrackets ||
                OPP_BRACKS[this.sides[this.side].ch] ===
    ...
    LatexCommandInput.prototype.createBlocks = function () {
        ...
        endsL.keystroke = function (key, e, ctrlr) {
            if (key === "Tab" || key === "Enter" || key === "Spacebar") {
                ...
                // TODO needs tests
                ctrlr.aria.alert(
                    cmd.mathspeak({ createdLeftOf: ctrlr.cursor }),
                );
                e === null || e === void 0 ? void 0 : e.preventDefault();
                return;
            }
    ...
    LatexCommandInput.prototype.createLeftOf = function (cursor) {
        ...
        if (this._replacedFragment) {
            ...
            this._replacedFragment
                .domFrag()
                .insertBefore(frag.children().first());
        }
    };
