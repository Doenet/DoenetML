 ...
 * field or a pegboard covers the whole viewport, so there is nowhere for a
 * label to sit and it has none of these. `labelPosition` is narrower still:
 * the components that can place their label somewhere declare it for
 * themselves.
 *
