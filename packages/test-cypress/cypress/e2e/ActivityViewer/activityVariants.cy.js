    ...
    it("Variants from single page, no variant control in page", () => {
        ...
        `;
            ...
            cy.window().then(async (win) => {
                ...
                expect(activityData.variantsByPage).eqls([
                    ((ind - 1) % 100) + 1,
                ]);
    ...
    `;
        ...
        for (let ind = 1; ind <= 2000; ind += 970) {
            ...
            cy.window().then(async (win) => {
                ...
                let mathinputSubmitAnchor =
                    "#page1" + mathinputName + "_submit";
                let mathinputCorrectAnchor =
                    "#page1" + mathinputName + "_correct";
                let mathinputIncorrectAnchor =
                    "#page1" + mathinputName + "_incorrect";
                ...
                cy.window().then(async (win) => {
                    ...
                    let textinputSubmitAnchor =
                        "#page2" + textinputName + "_submit";
                    let textinputCorrectAnchor =
                        "#page2" + textinputName + "_correct";
                    let textinputIncorrectAnchor =
                ...
                cy.get(cesc("#page2\\/_text1"))
                    ...
                    .then(async () => {
                        let stateVariables2 =
                            await win.returnAllStateVariables2();
                        let title2 =
                            stateVariables2["/_title1"].stateValues.value;
