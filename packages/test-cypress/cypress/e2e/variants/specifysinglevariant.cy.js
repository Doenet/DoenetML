                ...
                cy.window().then(async (win) => {
                    ...
                    cy.window().then(async (win) => {
                        let stateVariables =
                            await win.returnAllStateVariables1();
                        let p =
                            stateVariables[await win.resolvePath1("p[1][1]")];
            ...
            for (let ind = 1; ind <= 4; ind++) {
                ...
                cy.window().then(async (win) => {
                    ...
                    cy.window().then(async (win) => {
                        ...
                        let orderC1 =
                            stateVariables[await win.resolvePath1("c1")]
                                .stateValues.choiceOrder;
                        let orderC2 =
                            stateVariables[await win.resolvePath1("c2")]
                                .stateValues.choiceOrder;

                        let orderC3 =
                            stateVariables[await win.resolvePath1("c3")]
                                .stateValues.choiceOrder;
                        let orderC4 =
                            stateVariables[await win.resolvePath1("c4")]
                                .stateValues.choiceOrder;
                        ...
                        cy.get(cesc(`#c1_choice1_input`)).should(
                            "not.be.checked",
                        );
      ...
      <text name="text1">1</text>${doenetML}`,
            ...
            cy.window().then(async (win) => {
                ...
                cy.window().then(async (win) => {
                    ...
                    expect(
                        stateVariables[await win.resolvePath1("g3.ci")]
                            .stateValues.choiceOrder,
                    ).eqls(choiceOrder);

                    expect(
                        stateVariables[await win.resolvePath1("g.ci")]
                    ...
                    expect(
                        stateVariables[await win.resolvePath1("g.ans")]
                            .stateValues.submittedResponses,
                    ).eqls([n]);
                    expect(
                        stateVariables[await win.resolvePath1("g2.ans")]
                            .stateValues.submittedResponses,
                    ).eqls([n]);
                    expect(
                        stateVariables[await win.resolvePath1("g3.ans")]
                            .stateValues.submittedResponses,
                    ).eqls([n]);
                    expect(
                        stateVariables[await win.resolvePath1("p3.ans")]
                            .stateValues.submittedResponses,
                    ).eqls([m]);
                });
