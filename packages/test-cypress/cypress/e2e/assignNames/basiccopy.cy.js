...
describe("Basic copy assignName Tests", function () {
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(
                stateVariables[
                    stateVariables["/cp2"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
            ...
            expect(
                stateVariables[
                    stateVariables["/cp5"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp6"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp7"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp8"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp9"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp10"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp11"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp12"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp13"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp14"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
            expect(
                stateVariables[
                    stateVariables["/cp15"].replacements[0].componentName
                ].stateValues.value,
            ).eq("hello");
        });
    });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(
                stateVariables[
                    stateVariables["/ex1"].replacements[0].componentName
                ].stateValues.value,
            ).eq("none");
            expect(
                stateVariables[
                    stateVariables["/ex2"].replacements[0].componentName
                ].stateValues.value,
            ).eq("full");
        });
    });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/hello/c"].stateValues.xs).eqls([
                    -9, -8,
                ]);
                expect(stateVariables["/hello/d"].stateValues.xs).eqls([3, 4]);
                expect(stateVariables["/hello/e"].stateValues.xs).eqls([
                    -9, -8,
                ]);
                expect(stateVariables["/hello/f"].stateValues.xs).eqls([3, 4]);
                expect(stateVariables["/e"].stateValues.xs).eqls([-9, -8]);
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/hello/d"].stateValues.xs).eqls([
                    -1, -3,
                ]);
                expect(stateVariables["/hello/e"].stateValues.xs).eqls([
                    -9, -8,
                ]);
                expect(stateVariables["/hello/f"].stateValues.xs).eqls([
                    -1, -3,
                ]);
                expect(stateVariables["/e"].stateValues.xs).eqls([-9, -8]);
                expect(stateVariables["/f"].stateValues.xs).eqls([-1, -3]);
