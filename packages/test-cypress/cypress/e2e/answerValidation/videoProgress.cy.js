...
describe("Video progress tests", function () {
    ...
    <callAction triggerWith="$v" target="$answer1" actionName="submitAnswer" />
    ...
    <p>Skip to time 157: <updateValue target="$v.time" newValue="157" name="skip1"><label>Skip 1</label></updateValue></p>
