...
describe("Vector Tag Tests", function () {
    ...
    async function testVectorCopiedHTD({
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables[vectorName].stateValues.tail).eqls([
                tailx,
                taily,
            ]);
            expect(stateVariables[vectorName].stateValues.head).eqls([
                headx,
                heady,
            ]);
            ...
            expect(stateVariables[tailName].stateValues.xs).eqls([
                tailx,
                taily,
            ]);
            expect(stateVariables[headName].stateValues.xs).eqls([
                headx,
                heady,
            ]);
            ...
            expect(
                stateVariables[displacementName].stateValues.displacement,
 ...
 `,
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/multiplied"].stateValues.tail).eqls([0, 0]);
            expect(stateVariables["/multiplied"].stateValues.head).eqls([
                -10, 2,
            ]);
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/u"].stateValues.tail).eqls([...uTail]);
                expect(stateVariables["/u"].stateValues.head).eqls([...uHead]);
                expect(stateVariables["/u"].stateValues.displacement).eqls([
                    ...u,
                ]);
                expect(stateVariables["/v"].stateValues.tail).eqls([...vTail]);
                expect(stateVariables["/v"].stateValues.head).eqls([...vHead]);
                ...
                expect(stateVariables["/w"].stateValues.tail).eqls([...wTail]);
                expect(stateVariables["/w"].stateValues.head).eqls([...wHead]);
                expect(stateVariables["/w"].stateValues.displacement).eqls([
                    ...w,
                ]);
            });
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/v1"].stateValues.head).eqls([
                t1x + x,
                t1y + y,
            ]);
            ...
            expect(stateVariables["/v2"].stateValues.head).eqls([
                t1x + x,
                t1y + y,
            ]);
            ...
            expect(stateVariables["/v3"].stateValues.head).eqls([
                t3x + x,
                t3y + y,
            ]);
            ...
            expect(stateVariables["/v4"].stateValues.head).eqls([
                t4x + y,
                t4y + x,
            ]);
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v1"].stateValues.displacement).eqls([
                    x,
                    y,
                ]);
                ...
                expect(stateVariables["/v2"].stateValues.displacement).eqls([
                    x,
                    y,
                ]);
                ...
                expect(stateVariables["/v3"].stateValues.displacement).eqls([
                    x,
                    y,
                ]);
                ...
                expect(stateVariables["/v4"].stateValues.displacement).eqls([
                    y,
                    x,
                ]);
            });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/_vector2"].stateValues.tail).eqls([
                    x3,
                    y3,
                ]);
                expect(stateVariables["/_vector2"].stateValues.head).eqls([
                    x2,
                    y2,
                ]);
                expect(stateVariables["/_vector3"].stateValues.tail).eqls([
                    x3,
                    y3,
                ]);
                expect(stateVariables["/_vector3"].stateValues.head).eqls([
                    x1,
                    y1,
                ]);
            });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v5"].stateValues.tail).eqls([0, 0]);
                expect(stateVariables["/v5"].stateValues.displacement).eqls([
                    1, 2,
                ]);
            });
        });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/v6"].stateValues.displacement).eqls([
                    -4, -3,
                ]);
            });
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            for (let i = 0; i < 7; i++) {
                for (let j = 0; j < 2; j++) {
                    expect(
                        stateVariables[`/g${j}/v${i}`].stateValues.tail,
                    ).eqls(tails[i]);
                    expect(
                        stateVariables[`/g${j}/v${i}`].stateValues.head,
                    ).eqls(heads[i]);
                    expect(
  ...
  `,
        ...
        cy.get(cesc("#\\/vdragt") + " .mjx-mrow").should(
            "contain.text",
            "(0,0)",
        );
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/g0/vnoheaddrag"].stateValues.tail).eqls([
                0, 0,
            ]);
            expect(stateVariables["/g0/vnoheaddrag"].stateValues.head).eqls([
                1, 2,
            ]);
            expect(stateVariables["/g0/vnotaildrag"].stateValues.tail).eqls([
                0, 0,
            ]);
            expect(stateVariables["/g0/vnotaildrag"].stateValues.head).eqls([
                1, 3,
            ]);
            ...
            expect(
                stateVariables["/g0/vnodragheadtaildrag"].stateValues.tail,
            ).eqls([0, 0]);
            expect(
                stateVariables["/g0/vnodragheadtaildrag"].stateValues.head,
            ).eqls([1, 8]);

            expect(stateVariables["/g1/vdrag"].stateValues.tail).eqls([0, 0]);
            expect(stateVariables["/g1/vdrag"].stateValues.head).eqls([1, 1]);
            expect(stateVariables["/g1/vnoheaddrag"].stateValues.tail).eqls([
                0, 0,
            ]);
            expect(stateVariables["/g1/vnoheaddrag"].stateValues.head).eqls([
                1, 2,
            ]);
            expect(stateVariables["/g1/vnotaildrag"].stateValues.tail).eqls([
                0, 0,
            ]);
            expect(stateVariables["/g1/vnotaildrag"].stateValues.head).eqls([
                1, 3,
            ]);
            ...
            expect(
                stateVariables["/g1/vnodragheadtaildrag"].stateValues.tail,
            ).eqls([0, 0]);
            expect(
                stateVariables["/g1/vnodragheadtaildrag"].stateValues.head,
            ).eqls([1, 8]);
        });
    ...
    `,
        ...
        cy.get(cesc("#\\/mimagnitude") + " textarea")
            .type("{ctrl+home}{shift+end}{backspace}5sqrt2{enter}", {
                force: true,
            })
            .then(() => {
                len = 5 * Math.sqrt(2);
  ...
  `,
        ...
        cy.get(cesc("#\\/vHead") + " .mjx-mrow").should(
            "contain.text",
            "(6,9)",
        );
        ...
        cy.get(cesc("#\\/vTail") + " .mjx-mrow").should(
            "contain.text",
            "(−3,7)",
        );
