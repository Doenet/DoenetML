...
describe("Sectioning Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section1"].stateValues.creditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section1"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section2"].stateValues.creditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section2"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section21"].stateValues.creditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section21"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section22"].stateValues.creditAchieved,
                ).eq(0);
                expect(
                    stateVariables["/section22"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
                ...
                expect(
                    stateVariables["/section221"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
                ...
                expect(
                    stateVariables["/section222"].stateValues
                        .percentCreditAchieved,
                ).eq(0);
                expect(
            ...
            let credit2 =
                (weight[0] + weight[2] + weight[4] + weight[6]) / totWeight;
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let section1credit2Round =
                Math.round(1000 * section1credit2) / 1000;
            ...
            let section21credit2Round =
                Math.round(1000 * section21credit2) / 1000;
            ...
            let section2credit2Round =
                Math.round(1000 * section2credit2) / 1000;
            ...
            cy.get(s1CaAnchor).should(
                "have.text",
                section1credit2Round.toString(),
            );
            cy.get(s1PcaAnchor).should(
                "have.text",
                section1percentCredit2Round.toString(),
            );
            cy.get(s2CaAnchor).should(
                "have.text",
                section2credit2Round.toString(),
            );
            cy.get(s2PcaAnchor).should(
                "have.text",
                section2percentCredit2Round.toString(),
            );
            cy.get(s21CaAnchor).should(
                "have.text",
                section21credit2Round.toString(),
            );
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section21"].stateValues.creditAchieved,
                ).closeTo(section21credit2, 1e-12);
                expect(
                    stateVariables["/section21"].stateValues
                        .percentCreditAchieved,
            ...
            let section1credit3Round =
                Math.round(1000 * section1credit3) / 1000;
            ...
            let section221credit3Round =
                Math.round(1000 * section221credit3) / 1000;
            ...
            let section21credit3Round =
                Math.round(1000 * section21credit3) / 1000;
            ...
            let section2credit3Round =
                Math.round(1000 * section2credit3) / 1000;
            ...
            cy.get(s21CaAnchor).should(
                "have.text",
                section21credit3Round.toString(),
            );
            cy.get(s21PcaAnchor).should(
                "have.text",
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section21"].stateValues.creditAchieved,
                ).closeTo(section21credit3, 1e-12);
                expect(
                    stateVariables["/section21"].stateValues
                        .percentCreditAchieved,
            ...
            let section1credit4Round =
                Math.round(1000 * section1credit4) / 1000;
            ...
            let section221credit4Round =
                Math.round(1000 * section221credit4) / 1000;
            ...
            let section222credit4Round =
                Math.round(1000 * section222credit4) / 1000;
            ...
            let section21credit4Round =
                Math.round(1000 * section21credit4) / 1000;
            ...
            let section2credit4Round =
                Math.round(1000 * section2credit4) / 1000;
            ...
            cy.get(s21CaAnchor).should(
                "have.text",
                section21credit4Round.toString(),
            );
            cy.get(s21PcaAnchor).should(
                "have.text",
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section21"].stateValues.creditAchieved,
                ).closeTo(section21credit4, 1e-12);
                expect(
                    stateVariables["/section21"].stateValues
                        .percentCreditAchieved,
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let credit2 =
                (1 + 0.5 * section1credit2 + 2 * section2credit2) / 3.5;
            let credit2Round = Math.round(1000 * credit2) / 1000;
            let percentCredit2 = credit2 * 100;
            let percentCredit2Round = Math.round(10 * percentCredit2) / 10;
            ...
            cy.get(s22CaAnchor).should(
                "have.text",
                section22credit2Round.toString(),
            );
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section22"].stateValues.creditAchieved,
                ).closeTo(section22credit2, 1e-12);
                expect(
                    stateVariables["/section22"].stateValues
                        .percentCreditAchieved,
            ...
            let section22credit3Round =
                Math.round(1000 * section22credit3) / 1000;
            ...
            let credit3 =
                (1 + 0.5 * section1credit3 + 2 * section2credit3) / 3.5;
            let credit3Round = Math.round(1000 * credit3) / 1000;
            let percentCredit3 = credit3 * 100;
            let percentCredit3Round = Math.round(10 * percentCredit3) / 10;
            ...
            cy.get(s22CaAnchor).should(
                "have.text",
                section22credit3Round.toString(),
            );
            cy.get(s22PcaAnchor).should(
                "have.text",
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section22"].stateValues.creditAchieved,
                ).closeTo(section22credit3, 1e-12);
                expect(
                    stateVariables["/section22"].stateValues
                        .percentCreditAchieved,
            ...
            let section22credit4Round =
                Math.round(1000 * section22credit4) / 1000;
            ...
            cy.get(s22CaAnchor).should(
                "have.text",
                section22credit4Round.toString(),
            );
            cy.get(s22PcaAnchor).should(
                "have.text",
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/section22"].stateValues.creditAchieved,
                ).closeTo(section22credit4, 1e-12);
                expect(
                    stateVariables["/section22"].stateValues
                        .percentCreditAchieved,
    ...
    `,
        ...
        cy.get(cesc("#\\/sec221_title")).should(
            "have.text",
            "Section 2.2.1: BBA",
        );
        cy.get(cesc("#\\/sec222_title")).should(
            "have.text",
            "Section 2.2.2: BBB",
        );
        cy.get(cesc("#\\/sec223_title")).should(
            "have.text",
            "Section 2.2.3: BBC",
        );
        cy.get(cesc("#\\/sec2231_title")).should(
    ...
    `,
        ...
        cy.get(cesc("#\\/sec2111_title")).should(
            "have.text",
            "Section 1.1: BAAA",
        );
        cy.get(cesc("#\\/sec2112_title")).should(
            "have.text",
            "Section 1.2: BAAB",
        );
