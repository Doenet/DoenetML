...
describe("Parabola Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let parabola3Name =
                stateVariables[
                    stateVariables["/g3"].replacements[0].componentName
                ...
                cy.window().then(async (win) => {
                    ...
                    expect(
                        me
                            .fromAst(
                                stateVariables[
                                    stateVariables["/v"].replacements[0]
                                        .componentName
                                ].stateValues.xs[0],
                            )
                            .evaluate_numbers().tree,
                    ...
                    expect(
                        me
                            .fromAst(
                                stateVariables[
                                    stateVariables["/p2"].replacements[0]
                                        .componentName
                    ...
                    expect(
                        me
                            .fromAst(
                                stateVariables[
                                    stateVariables["/v2"].replacements[0]
                                        .componentName
                                ].stateValues.xs[0],
                            )
                            .evaluate_numbers().tree,
                    ...
                    expect(
                        me
                            .fromAst(
                                stateVariables[
                                    stateVariables["/e2"].replacements[0]
                                        .componentName
                                ].stateValues.value,
                            )
                            .equals(equationExpression),
                    ).eq(true);
                    expect(stateVariables[parabola3Name].stateValues.a).closeTo(
                        a,
                        1e-12,
                    );
                    expect(stateVariables[parabola3Name].stateValues.b).closeTo(
                        b,
                        1e-12,
                    );
                    expect(stateVariables[parabola3Name].stateValues.c).closeTo(
                        c,
                        1e-12,
                    );
                    expect(
                        me
                            .fromAst(
                                stateVariables[parabola3Name].stateValues
                                    .equation,
                            )
                            .equals(equationExpression),
                    ).eq(true);
                    ...
                    expect(
                        me
                            .fromAst(
                                stateVariables[vertex3Name].stateValues.xs[0],
                            )
                            .evaluate_numbers().tree,
                    ).closeTo(vertex_x, 1e-12);
                    expect(
                        me
                            .fromAst(
                                stateVariables[vertex3Name].stateValues.xs[1],
                            )
                            .evaluate_numbers().tree,
                    ).closeTo(vertex_y, 1e-12);
                });
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                cy.window().then(async (win) => {
                    ...
                    expect(
                        stateVariables[parabola3Name].stateValues.vertex,
                    ).eqls(["\uff3f", "\uff3f"]);
                    expect(stateVariables[vertex3Name].stateValues.xs[0]).eq(
                        "\uff3f",
                    );
                    expect(stateVariables[vertex3Name].stateValues.xs[1]).eq(
                        "\uff3f",
                    );
                    expect(
                        me
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                cy.window().then(async (win) => {
                    ...
                    expect(
                        stateVariables[parabola3Name].stateValues.vertex[0],
                    ).eq("\uff3f");
                    expect(
                        stateVariables[parabola3Name].stateValues.vertex[1],
                    ).eq("\uff3f");
                    expect(stateVariables[vertex3Name].stateValues.xs[0]).eq(
                        "\uff3f",
                    );
