...
describe("Point Tag Tests 2", function () {
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/_point1"].stateValues.xs[0]).eqls([
                "*",
                2,
                "x",
            ]);
            ...
            expect(stateVariables["/_point1"].stateValues.xs[2]).eqls([
                "^",
                "w",
                2,
            ]);
            expect(stateVariables["/_point1"].stateValues.x1).eqls([
                "*",
                2,
                "x",
            ]);
            expect(stateVariables["/_point1"].stateValues.x2).eqls([
                "/",
                "u",
                "v",
            ]);
            expect(stateVariables["/_point1"].stateValues.x3).eqls([
                "^",
                "w",
                2,
            ]);
            ...
            expect(stateVariables["/point2"].stateValues.xs[0]).eqls([
                "*",
                2,
                "x",
            ]);
            expect(stateVariables["/point2"].stateValues.xs[1]).eqls([
                "/",
                "u",
                "v",
            ]);
            expect(stateVariables["/point2"].stateValues.xs[2]).eqls([
                "^",
                "w",
                2,
            ]);
            expect(stateVariables["/point2"].stateValues.x1).eqls([
                "*",
                2,
                "x",
            ]);
            expect(stateVariables["/point2"].stateValues.x2).eqls([
                "/",
                "u",
                "v",
            ]);
            expect(stateVariables["/point2"].stateValues.x3).eqls([
                "^",
                "w",
                2,
            ]);
            ...
            expect(stateVariables["/point3"].stateValues.xs[0]).eqls([
                "*",
                2,
                "x",
            ]);
            expect(stateVariables["/point3"].stateValues.xs[1]).eqls([
                "/",
                "u",
                "v",
            ]);
            expect(stateVariables["/point3"].stateValues.xs[2]).eqls([
                "^",
                "w",
                2,
            ]);
            expect(stateVariables["/point3"].stateValues.x1).eqls([
                "*",
                2,
                "x",
            ]);
            expect(stateVariables["/point3"].stateValues.x2).eqls([
                "/",
                "u",
                "v",
            ]);
            expect(stateVariables["/point3"].stateValues.x3).eqls([
                "^",
                "w",
                2,
            ]);
  ...
  `,
    ...
    `,
        ...
        cy.get(cesc("#\\/ti1_input"))
            .clear()
            .type("\\(\\frac{{}Q}{{}1}\\){enter}");
        cy.get(cesc("#\\/ti2_input"))
            .clear()
            .type("\\(\\frac{{}Q}{{}2}\\){enter}");
        cy.get(cesc("#\\/ti3_input"))
            .clear()
            .type("\\(\\frac{{}Q}{{}3}\\){enter}");
        cy.get(cesc("#\\/ti4_input"))
            .clear()
            .type("\\(\\frac{{}Q}{{}4}\\){enter}");
        cy.get(cesc("#\\/theLabel4") + " .mjx-mrow").should(
            "contain.text",
