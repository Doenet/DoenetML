...
describe("MathList Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let child9Name =
                stateVariables["/mid2"].activeChildren[0].componentName;
            let ca9 = cesc2("#" + child9Name);
            let child10Name =
                stateVariables[
                    stateVariables["/mid2"].activeChildren[1].componentName
            ...
            for (let changeInd in mapping) {
                cy.window().then(async (win) => {
                    ...
                    cy.window().then(async (win) => {
                        ...
                        let maths =
                            stateVariables["/_mathlist1"].stateValues.maths;
      ...
      `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/ml4"].stateValues.maths).eqls([
                    "a",
                    "b",
                    "c",
                ]);
    ...
    `,
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            expect(stateVariables["/ml"].stateValues.maths).eqls([
                "a",
                "b",
                "c",
            ]);
    ...
    `,
        ...
        cy.get(cesc2("#/maxnum") + " textarea").type(
            "{end}{backspace}6{enter}",
            {
                force: true,
            },
