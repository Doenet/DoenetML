...
describe("Point Tag Tests", function () {
  ...
  <p><textinput bindValueTo="$grp[1].label" name="tic3" /></p>
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let c3p =
                stateVariables[
                    stateVariables["/grp"].replacements[0].componentName
  ...
  <p>text of label for F: <text copySource="F" copyProp="label" name="tF" /></p>
    ...
    `,
        ...
        cy.get(cesc("#\\/coords") + " textarea").type("-3{enter}", {
            force: true,
        });
  ...
  `,
        ...
        cy.get(cesc("#\\/yoffset") + " textarea").type("0{enter}", {
            force: true,
        });
  ...
  `,
        ...
        cy.get(cesc("#\\/xthreshold") + " textarea").type("0.2", {
            force: true,
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/A"].stateValues.coords).eqls([
                "vector",
                -1,
                -5,
            ]);
  ...
  <text>a</text>
    `,
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            let x1 =
                stateVariables["/_point1"].attributes.xs.component
                    .activeChildren[0];
            ...
            cy.window().then(async (win) => {
                let math3 =
                    stateVariables["/_sequence1"].replacements[0].adapterUsed;
