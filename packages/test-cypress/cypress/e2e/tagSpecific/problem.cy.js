...
describe("Problem Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let problem1credit2Round =
                Math.round(1000 * problem1credit2) / 1000;
            ...
            let problem21credit2Round =
                Math.round(1000 * problem21credit2) / 1000;
            ...
            let problem22credit2Round =
                Math.round(1000 * problem22credit2) / 1000;
            ...
            let problem2credit2Round =
                Math.round(1000 * problem2credit2) / 1000;
            ...
            let problem1credit3Round =
                Math.round(1000 * problem1credit3) / 1000;
            ...
            let problem21credit3Round =
                Math.round(1000 * problem21credit3) / 1000;
            ...
            let problem221credit3Round =
                Math.round(1000 * problem221credit3) / 1000;
            ...
            let problem22credit3Round =
                Math.round(1000 * problem22credit3) / 1000;
            ...
            let problem2credit3Round =
                Math.round(1000 * problem2credit3) / 1000;
            ...
            let problem1credit4Round =
                Math.round(1000 * problem1credit4) / 1000;
            ...
            let problem221credit4Round =
                Math.round(1000 * problem221credit4) / 1000;
            ...
            let problem222credit4Round =
                Math.round(1000 * problem222credit4) / 1000;
            ...
            let problem21credit4Round =
                Math.round(1000 * problem21credit4) / 1000;
            ...
            let problem22credit4Round =
                Math.round(1000 * problem22credit4) / 1000;
            ...
            let problem2credit4Round =
                Math.round(1000 * problem2credit4) / 1000;
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let problem2credit2 =
                (3 * problem21credit2 + 4 * problem22credit2) / 8;
            let problem2credit2Round =
                Math.round(1000 * problem2credit2) / 1000;
            let problem2percentCredit2 = problem2credit2 * 100;
            let problem2percentCredit2Round =
            ...
            let credit2 =
                (1 + 0.5 * problem1credit2 + 2 * problem2credit2) / 3.5;
            let credit2Round = Math.round(1000 * credit2) / 1000;
            let percentCredit2 = credit2 * 100;
            let percentCredit2Round = Math.round(10 * percentCredit2) / 10;
            ...
            let credit3 =
                (1 + 0.5 * problem1credit3 + 2 * problem2credit3) / 3.5;
            let credit3Round = Math.round(1000 * credit3) / 1000;
            let percentCredit3 = credit3 * 100;
            let percentCredit3Round = Math.round(10 * percentCredit3) / 10;
