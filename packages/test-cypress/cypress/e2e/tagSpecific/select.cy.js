...
describe("Select Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            for (let ind = 1; ind <= 5; ind++) {
                let x =
                    stateVariables["/s" + ind + "/x" + ind].stateValues.value;
                let y =
                    stateVariables["/s" + ind + "/y" + ind].stateValues.value;
                let z =
                    stateVariables["/s" + ind + "/z" + ind].stateValues.value;
            ...
            for (let ind = 1; ind <= 5; ind++) {
                ...
                for (let i = 3; i < 5; i++) {
                    expect(
                        ["x", "y", "z"].includes(
                            stateVariables[
                                stateVariables[s.replacements[i].componentName]
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables["/noresamplelist"].replacements[0]
                            .componentName
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables["/noreresamplelist"].replacements[0]
                            .componentName
                    ].activeChildren[0].componentName
                ].stateValues.value,
            ).eq(x1);
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables[
                            stateVariables["/noresamplep"].replacements[0]
                                .componentName
                        ].activeChildren[1].componentName
                    ].activeChildren[0].componentName
                ].stateValues.value,
            ...
            expect(
                stateVariables[
                    stateVariables[
                        stateVariables[
                            stateVariables["/noreresamplep"].replacements[0]
                                .componentName
                        ].activeChildren[1].componentName
                    ].activeChildren[0].componentName
                ].stateValues.value,
            ...
            for (let ind = 0; ind < 1; ind++) {
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p4"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p5"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p6"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p7"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p8"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
                ...
                expect(
                    stateVariables[
                        stateVariables[
                            stateVariables[
                                stateVariables["/p9"].replacements[0]
                                    .componentName
                            ].activeChildren[0].componentName
                        ].activeChildren[ind].componentName
                    ].stateValues.value,
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            for (let name of ["/p1", "/q1"]) {
                ...
                for (let ind = 0; ind < 3; ind++) {
                    expect(aslistChildren[ind].stateValues.value).eq(
                        list1[ind],
                    );
                }
            }
            ...
            for (let name of ["/p1", "/q1"]) {
                ...
                for (let ind1 = 0; ind1 < 3; ind1++) {
                    for (let ind2 = 0; ind2 < 3; ind2++) {
                        expect(
                            aslistChildren[ind1 * 3 + ind2].stateValues.value,
                        ).eq(listsByInd[ind1][ind2]);
                    }
                }
            }
        });
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let qx =
                stateVariables[
                    stateVariables["/qx"].replacements[0].componentName
                ].stateValues.value;
            expect(qx).eq(xoption[q2string]);
            let repeatqmath = me.fromAst(
                stateVariables[
                    stateVariables[
                        stateVariables["/repeat"].activeChildren[0]
                            .componentName
                    ].activeChildren[1].componentName
                ].stateValues.value,
            );
            ...
            let rx =
                stateVariables[
                    stateVariables["/rx"].replacements[0].componentName
                ].stateValues.value;
            expect(rx).eq(xoption[r2string]);
            let repeatrmath = me.fromAst(
                stateVariables[
                    stateVariables[
                        stateVariables["/repeat"].activeChildren[1]
                            .componentName
                    ].activeChildren[1].componentName
                ].stateValues.value,
            );
            ...
            let sx =
                stateVariables[
                    stateVariables["/sx"].replacements[0].componentName
                ].stateValues.value;
            expect(sx).eq(xoption[s2string]);
            let repeatsmath = me.fromAst(
                stateVariables[
                    stateVariables[
                        stateVariables["/repeat"].activeChildren[2]
                            .componentName
                    ].activeChildren[1].componentName
                ].stateValues.value,
            );
            ...
            let tx =
                stateVariables[
                    stateVariables["/tx"].replacements[0].componentName
                ].stateValues.value;
            expect(tx).eq(xoption[t2string]);
            let repeattmath = me.fromAst(
                stateVariables[
                    stateVariables[
                        stateVariables["/repeat"].activeChildren[3]
                            .componentName
                    ].activeChildren[1].componentName
                ].stateValues.value,
            );
            ...
            let ux =
                stateVariables[
                    stateVariables["/ux"].replacements[0].componentName
                ].stateValues.value;
            expect(ux).eq(xoption[u2string]);
            let repeatumath = me.fromAst(
                stateVariables[
                    stateVariables[
                        stateVariables["/repeat"].activeChildren[4]
                            .componentName
                    ].activeChildren[1].componentName
                ].stateValues.value,
            );
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let xorig =
                stateVariables[
                    stateVariables[
                        stateVariables["/_select1"].replacements[0]
                            .componentName
                    ].replacements[0].componentName
                ].stateValues.value;
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let yorig =
                stateVariables[
                    stateVariables[
                        stateVariables["/_select1"].replacements[1]
                            .componentName
                    ].replacements[0].componentName
                ].stateValues.value;
            expect(yorig).eq(y);
            let zorig =
                stateVariables[
                    stateVariables[
                        stateVariables["/_select1"].replacements[2]
                            .componentName
                    ].replacements[0].componentName
                ].stateValues.value;
            expect(zorig).eq(z);
            ...
            let y2 =
                stateVariables[
                    stateVariables["/y2"].replacements[0].componentName
                ].stateValues.value;
            expect(y2).eq(y);
            let z2 =
                stateVariables[
                    stateVariables["/z2"].replacements[0].componentName
                ].stateValues.value;
            expect(z2).eq(z);
    ...
    `,
        ...
        let options = ["x^2", "x/y", "u", "a", "b-c", "s+t", "mn", "-1"].map(
            (x) => me.fromText(x),
        );
        ...
        cy.window().then(async (win) => {
            ...
            for (let ind = 1; ind <= 5; ind++) {
                let math = me.fromAst(
                    stateVariables["/m" + ind].stateValues.value,
                );
                expect(options.some((x) => x.equalsViaSyntax(math))).eq(true);
                expect(mathsSoFar.some((x) => x.equalsViaSyntax(math))).eq(
                    false,
                );
        ...
        cy.window().then(async (win) => {
            ...
            for (let ind = 1; ind <= 6; ind++) {
                ...
                if (comp.componentType === "math") {
                    ...
                    math = me.fromAst(
                        stateVariables[comp.replacements[0].componentName]
                            .stateValues.value,
                    );
                }
                expect(options.some((x) => x.equalsViaSyntax(math))).eq(true);
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let q3s = [
                stateVariables[
                    stateVariables["/qq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/qr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/qq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/qr2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let r3s = [
                stateVariables[
                    stateVariables["/rq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/rr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/rq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/rr2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let s3s = [
                stateVariables[
                    stateVariables["/sq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/sr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/sq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/sr2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let t3s = [
                stateVariables[
                    stateVariables["/tq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/tr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/tq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/tr2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let u3s = [
                stateVariables[
                    stateVariables["/uq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/ur"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/uq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/ur2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let v3s = [
                stateVariables[
                    stateVariables["/vq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/vr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/vq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/vr2"].replacements[0].componentName
                ].stateValues.value,
            ];
            let w3s = [
                stateVariables[
                    stateVariables["/wq"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/wr"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/wq2"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/wr2"].replacements[0].componentName
                ].stateValues.value,
            ];
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let q4s = [
                stateVariables[
                    stateVariables["/qq3"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/qr3"].replacements[0].componentName
                ].stateValues.value,
            ];
            let r3s = [
                stateVariables[
            ...
            let r4s = [
                stateVariables[
                    stateVariables["/rq3"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/rr3"].replacements[0].componentName
                ].stateValues.value,
            ];
            let s3s = [
                stateVariables[
            ...
            let s4s = [
                stateVariables[
                    stateVariables["/sq3"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/sr3"].replacements[0].componentName
                ].stateValues.value,
            ];
            let t3s = [
                stateVariables[
            ...
            let t4s = [
                stateVariables[
                    stateVariables["/tq3"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/tr3"].replacements[0].componentName
                ].stateValues.value,
            ];
            let u3s = [
                stateVariables[
            ...
            let u4s = [
                stateVariables[
                    stateVariables["/uq3"].replacements[0].componentName
                ].stateValues.value,
                stateVariables[
                    stateVariables["/ur3"].replacements[0].componentName
                ].stateValues.value,
            ];
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let option =
                options[
                    stateVariables["/_select1"].stateValues.selectedIndices[0] -
                        1
                ];

            expect(
                me.fromAst(chosenChildren[0].stateValues.value).toString(),
            ).eq(option.a);
            expect(
                me.fromAst(chosenChildren[1].stateValues.value).toString(),
            ).eq(option.b);
            expect(
                me.fromAst(chosenChildren[2].stateValues.value).toString(),
            ).eq(option.c);
            expect(
                me.fromAst(chosenChildren[3].stateValues.value).toString(),
            ).eq(option.d);

            let a2 = me
                .fromAst(
                    stateVariables[
                        stateVariables["/a2"].replacements[0].componentName
                    ].stateValues.value,
                )
                .toString();
            let b2 = me
                .fromAst(
                    stateVariables[
                        stateVariables["/b2"].replacements[0].componentName
                    ].stateValues.value,
                )
                .toString();
            let c2 = me
                .fromAst(
                    stateVariables[
                        stateVariables["/c2"].replacements[0].componentName
                    ].stateValues.value,
                )
                .toString();
            let d2 = me
                .fromAst(
                    stateVariables[
                        stateVariables["/d2"].replacements[0].componentName
                    ].stateValues.value,
                )
                .toString();
            let v2 = me
        ...
        cy.window().then(async (win) => {
            ...
            let theList4 = [...Array(24).keys()].map((i) =>
                me
                    .fromAst(
                        stateVariables[
                            stateVariables["/p" + (i + 1)].replacements[0]
                                .componentName
                        ].stateValues.value,
                    )
                    .toString(),
