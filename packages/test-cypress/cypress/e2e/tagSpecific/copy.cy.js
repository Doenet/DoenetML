...
describe("Copy Tag Tests", function () {
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/r1"].stateValues.modifyIndirectly).eq(
                false,
            );
            ...
            expect(stateVariables["/r6"].stateValues.modifyIndirectly).eq(
                false,
            );
            expect(stateVariables["/r7"].stateValues.modifyIndirectly).eq(
                false,
            );
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/mr"].stateValues.modifyIndirectly).eq(
                false,
            );
            ...
            expect(stateVariables["/mr2"].stateValues.modifyIndirectly).eq(
                true,
            );
            ...
            // modifyIndirectly attribute is copied (as it has propagateToProps=true)
            expect(stateVariables["/frmt"].stateValues.modifyIndirectly).eq(
                false,
            );
            // hide attribute is not copied (default behavior)
            ...
            expect(stateVariables["/frmt2"].stateValues.modifyIndirectly).eq(
                false,
            );
            ...
            expect(stateVariables["/frmt3"].stateValues.modifyIndirectly).eq(
                false,
            );
            ...
            expect(stateVariables["/A"].stateValues.label).eq("A");
            expect(stateVariables["/cA"].stateValues.value).eqls([
                "vector",
                1,
                2,
            ]);
            ...
            expect(stateVariables["/lmr"].stateValues.modifyIndirectly).eq(
                false,
            );
            expect(stateVariables["/A2"].stateValues.label).eq("A");
            expect(stateVariables["/cA2"].stateValues.value).eqls([
                "vector",
                1,
                2,
            ]);
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(
                    stateVariables["/_vector1"].stateValues.displacement,
                ).eqls([...displacement]);
                expect(stateVariables["/d1"].stateValues.tail).eqls([
                    ...d_tail,
                ]);
                expect(stateVariables["/d1"].stateValues.head).eqls([
                    ...d_head,
                ]);
                expect(stateVariables["/d1"].stateValues.displacement).eqls([
                    ...displacement,
                ]);
                expect(stateVariables["/d2"].stateValues.tail).eqls([
                    ...d_tail,
                ]);
                expect(stateVariables["/d2"].stateValues.head).eqls([
                    ...d_head,
                ]);
                expect(stateVariables["/d2"].stateValues.displacement).eqls([
                    ...displacement,
        ...
        cy.get(cesc2("#/problem1/_p1"))
            ...
            .then((text) => {
                ...
                cy.window().then(async (win) => {
                    ...
                    expect(stateVariables["/_copy1"].stateValues.doenetId).eq(
                        "abcdefg",
                    );
    ...
    `,
        ...
        cy.log(`select correct answer for problem 1`).then(() => {
            ...
            cy.get(cesc2("#/set2/problem34/problem1/_choiceinput1"))
                ...
                .click({ force: true });
            cy.get(
                cesc2("#/set2/problem34/problem1/_choiceinput1_submit"),
            ).click();
            cy.get(
                cesc2("#/set2/problem34/problem1/_choiceinput1_correct"),
            ).should("be.visible");
            cy.get(
                cesc2("#/set2/problem34/problem1/_choiceinput1_incorrect"),
            ).should("not.exist");
    ...
    `,
        ...
        cy.log(`select correct answer for problem 1`).then(() => {
            ...
            cy.get(cesc2("#/set1/problem12/problem1/_choiceinput1"))
                ...
                .click({ force: true });
            cy.get(
                cesc2("#/set1/problem12/problem1/_choiceinput1_submit"),
            ).click();
            cy.get(
                cesc2("#/set1/problem12/problem1/_choiceinput1_correct"),
            ).should("be.visible");
            cy.get(
                cesc2("#/set1/problem12/problem1/_choiceinput1_incorrect"),
            ).should("not.exist");
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/gnolink/l"].stateValues.point1).eqls([
                1, 2,
            ]);
            expect(stateVariables["/gnolink/l"].stateValues.point2).eqls([
                3, 4,
            ]);
    ...
    `,
        ...
        cy.get(cesc2("#/greet/greetings/s/s/hi")).should(
            "have.text",
            "Marhaban",
        );
        cy.get(cesc2("#/greet/greetings/s/s/l1")).should(
            "have.text",
            "Marhaban",
        );
    ...
    `;
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            expect(
                stateVariables["/problem1/_select1"].stateValues
                    .currentVariantName,
            ).eq("cat");
            let choices =
            ...
            cy.get(
                cesc2(`#/problem1/_choiceinput1_choice${catInd}_input`),
            ).click();
        });
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables[c2pChildNames[0]].stateValues.value).eq(
                    1,
                );
                expect(stateVariables[c2pChildNames[1]].stateValues.value).eq(
                    2,
                );
                expect(stateVariables[c2pChildNames[2]].stateValues.value).eq(
                    3,
                );
                ...
                expect(stateVariables[c3pChildNames[0]].stateValues.value).eq(
                    1,
                );
                expect(stateVariables[c3pChildNames[1]].stateValues.value).eq(
                    2,
                );
                expect(stateVariables[c3pChildNames[2]].stateValues.value).eq(
                    3,
                );
                ...
                expect(stateVariables[c4pChildNames[0]].stateValues.value).eq(
                    1,
                );
                expect(stateVariables[c4pChildNames[1]].stateValues.value).eq(
                    2,
                );
                expect(stateVariables[c4pChildNames[2]].stateValues.value).eq(
                    3,
                );
                ...
                expect(stateVariables[c5pChildNames[0]].stateValues.value).eq(
                    1,
                );
                expect(stateVariables[c5pChildNames[1]].stateValues.value).eq(
                    2,
                );
                expect(stateVariables[c5pChildNames[2]].stateValues.value).eq(
                    3,
                );
                ...
                let c7sGrandChildNames = stateVariables[
                    c7sChildName
                ].activeChildren
                    .filter((x) => x.componentName)
                    .map((x) => x.componentName);
                ...
                expect(
                    stateVariables[c7sGrandChildNames[0]].stateValues.value,
                ).eq(1);
                expect(
                    stateVariables[c7sGrandChildNames[1]].stateValues.value,
                ).eq(2);
                expect(
                    stateVariables[c7sGrandChildNames[2]].stateValues.value,
                ).eq(3);
                ...
                let c8sGrandChildNames = stateVariables[
                    c8sChildName
                ].activeChildren
                    .filter((x) => x.componentName)
                    .map((x) => x.componentName);
                ...
                expect(
                    stateVariables[c8sGrandChildNames[0]].stateValues.value,
                ).eq(1);
                expect(
                    stateVariables[c8sGrandChildNames[1]].stateValues.value,
                ).eq(2);
                expect(
                    stateVariables[c8sGrandChildNames[2]].stateValues.value,
                ).eq(3);
                ...
                let c9sGrandChildNames = stateVariables[
                    c9sChildName
                ].activeChildren
                    .filter((x) => x.componentName)
                    .map((x) => x.componentName);
                ...
                expect(
                    stateVariables[c9sGrandChildNames[0]].stateValues.value,
                ).eq(1);
                expect(
                    stateVariables[c9sGrandChildNames[1]].stateValues.value,
                ).eq(2);
                expect(
                    stateVariables[c9sGrandChildNames[2]].stateValues.value,
                ).eq(3);
                ...
                let c10sGrandChildNames = stateVariables[
                    c10sChildName
                ].activeChildren
                    .filter((x) => x.componentName)
                    .map((x) => x.componentName);
                ...
                expect(
                    stateVariables[c10sGrandChildNames[0]].stateValues.value,
                ).eq(1);
                expect(
                    stateVariables[c10sGrandChildNames[1]].stateValues.value,
                ).eq(2);
                expect(
                    stateVariables[c10sGrandChildNames[2]].stateValues.value,
                ).eq(3);
            });
        });
    });
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            let s1aChildName =
                stateVariables["/s1a"].activeChildren[0].componentName;
            ...
            expect(stateVariables[s1aGrandChildNames[0]].stateValues.value).eq(
                1,
            );
            expect(stateVariables[s1aGrandChildNames[1]].stateValues.value).eq(
                2,
            );
            expect(stateVariables[s1aGrandChildNames[2]].stateValues.value).eq(
                3,
            );
        });
    });
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            // put in window just so happens after above
            cy.window().then(async (win) => {
                expect(stateVariables["/c1/grp/_number1"].stateValues.value).eq(
                    1,
                );
                expect(stateVariables["/c1/grp/_number2"].stateValues.value).eq(
                    2,
                );
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables[c6pChildNames[0]].stateValues.value).eq(
                    1,
                );
                expect(stateVariables[c6pChildNames[1]].stateValues.value).eq(
                    2,
                );
                expect(stateVariables[c6pChildNames[2]].stateValues.value).eq(
                    3,
                );
                ...
                let c11sGrandChildNames = stateVariables[
                    c11sChildName
                ].activeChildren
                    .filter((x) => x.componentName)
                    .map((x) => x.componentName);
                ...
                expect(
                    stateVariables[c11sGrandChildNames[0]].stateValues.value,
                ).eq(1);
                expect(
                    stateVariables[c11sGrandChildNames[1]].stateValues.value,
                ).eq(2);
                expect(
                    stateVariables[c11sGrandChildNames[2]].stateValues.value,
                ).eq(3);
            });
        });
    });
    ...
    `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/al2/n1"].stateValues.value).eq(
                    "\uff3f",
                );
            });
        });
