...
describe("Line Tag Tests", function () {
  ...
  $_line1.point2{assignNames="p2"}
    `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/_line1"].stateValues.slope).eqls([
                "/",
                5,
                3,
            ]);
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            expect(stateVariables["/_line3"].stateValues.points[0]).eqls([
                x1,
                y1,
            ]);
            expect(stateVariables["/_line3"].stateValues.points[1]).eqls([
                x3,
                y3,
            ]);
        });
  ...
  `,
        ...
        cy.window().then(async (win) => {
            ...
            cy.window().then(async (win) => {
                ...
                expect(stateVariables["/la"].stateValues.points[0]).eqls([
                    x1,
                    y1,
                ]);
                expect(stateVariables["/la"].stateValues.points[1]).eqls([
                    x2,
                    y2,
                ]);
                expect(stateVariables["/p1"].stateValues.coords).eqls([
  ...
  $B2{name="B2a"}
    `,
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            expect(stateVariables["/l1"].stateValues.points[0]).eqls([
                A1x,
                A1y,
            ]);
            expect(stateVariables["/l1"].stateValues.points[1]).eqls([
                B1x,
                B1y,
            ]);
  ...
  $B2{name="B2a"}
    `,
        ...
        cy.window().then(async (win) => {
            let stateVariables = await win.returnAllStateVariables1();
            expect(stateVariables["/l1"].stateValues.endpoints[0]).eqls([
                A1x,
                A1y,
            ]);
            expect(stateVariables["/l1"].stateValues.endpoints[1]).eqls([
                B1x,
                B1y,
            ]);
            expect(stateVariables["/l2"].stateValues.points[0]).eqls([
