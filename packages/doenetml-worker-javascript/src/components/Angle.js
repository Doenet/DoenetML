    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.points = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                let numPointsSpecified =
                    globalDependencyValues.numPointsSpecified;
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.radians !== null) {
                    return {
                        setValue: {
                            radians:
                                dependencyValues.radians.stateValues.value.simplify(),
                            swapPointOrder,
                        },
                    };
        ...
        stateVariableDefinitions.degrees = {
            ...
            definition({ dependencyValues }) {
                ...
                if (
                    ...
                    let radNum =
                        dependencyValues.radians.evaluate_to_constant();
        ...
        stateVariableDefinitions.numericalRadius = {
            ...
            definition({ dependencyValues }) {
                let numericalRadius =
                    dependencyValues.radius.evaluate_to_constant();
