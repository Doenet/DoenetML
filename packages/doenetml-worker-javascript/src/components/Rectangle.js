    ...
    static returnStateVariableDefinitions() {
            ...
            inverseArrayDefinitionByKey({ desiredStateVariableValues }) {
                ...
                for (let arrayKey in desiredStateVariableValues.essentialVertex) {
                    instructions.push({
                        ...
                        value: {
                            [arrayKey]:
                                desiredStateVariableValues.essentialVertex[
                                    arrayKey
                                ],
                        },
                    });
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.widthAttr !== null) {
                    return {
                        setValue: {
                            specifiedWidth:
                                dependencyValues.widthAttr.stateValues.value,
                        },
                    };
                } else if (
                    ...
                    return {
                        useEssentialOrDefaultValue: { specifiedWidth: true },
                    };
                }
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.specifiedWidth,
                                childIndex: 0,
                                variableIndex: 0,
                            },
                        ],
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.heightAttr !== null) {
                    return {
                        setValue: {
                            specifiedHeight:
                                dependencyValues.heightAttr.stateValues.value,
                        },
                    };
                } else if (
                    (dependencyValues.haveSpecifiedCenter ? 1 : 0) +
                    ...
                    return {
                        useEssentialOrDefaultValue: { specifiedHeight: true },
                    };
                }
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.specifiedHeight,
                                variableIndex: 0,
                            },
                        ],
                    };
        ...
        stateVariableDefinitions.center = {
            ...
            async inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.center) {
                    ...
                    let offset = desiredStateVariableValues.center[
                        dim
                    ].subtract(center[dim]);
                    ...
                    instructions.push(
                        {
                            setDependency:
                                dependencyNamesByKey[arrayKey].vertex0,
        ...
        stateVariableDefinitions.width = {
            ...
            inverseDefinition({
                ...
                let offset =
                    (widthSign *
                        Math.max(0, desiredStateVariableValues.width)) /
                    2;
        ...
        stateVariableDefinitions.height = {
            ...
            inverseDefinition({
                ...
                let offset =
                    (heightSign *
                        Math.max(0, desiredStateVariableValues.height)) /
                    2;
                ...
                if (globalDependencyValues.numVerticesSpecified === 0) {
                    ...
                    if (globalDependencyValues.haveSpecifiedCenter) {
                        ...
                        for (let arrayKey of arrayKeys) {
                            ...
                            let verticesAttr =
                                dependencyValuesByKey[arrayKey].verticesAttr;
                            let vertComponent;

                            if (
                                verticesAttr !== null &&
                                Object.keys(verticesAttr.stateValues).length ===
                                    1
                            ) {
                            ...
                            if (
                                (dim === "0" &&
                                    (vertexInd === "0" || vertexInd === "3")) ||
                                (dim === "1" &&
                                    (vertexInd === "0" || vertexInd === "1"))
                            ) {
                                vertices[arrayKey] = vertComponent;
                            } else {
                                let centerComponent =
            ...
            async inverseArrayDefinitionByKey({
                ...
                if (globalDependencyValues.numVerticesSpecified === 0) {
                    ...
                    if (keyV2X !== undefined) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[keyV2X].verticesAttr,
                    ...
                    if (keyV2Y !== undefined) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[keyV2Y].verticesAttr,
