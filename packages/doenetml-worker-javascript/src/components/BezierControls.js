            ...
            arrayDefinitionByKey({ dependencyValuesByKey, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (controlChild && controlChild.length === 1) {
                        directions[arrayKey] =
                            controlChild[0].stateValues.direction;
                    } else {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (controlChild && controlChild.length === 1) {
                        hiddenControls[arrayKey] =
                            controlChild[0].stateValues.hide;
                    } else {
            ...
            inverseArrayDefinitionByKey({ desiredStateVariableValues }) {
                ...
                for (let arrayKey in desiredStateVariableValues.essentialSymmetricControls) {
                    newControlValues[arrayKey] =
                        desiredStateVariableValues.essentialSymmetricControls[
                            arrayKey
                        ];
                }
            ...
            returnArrayDependenciesByKey({ arrayKeys, stateValues }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (
                        ...
                        let controlInd =
                            stateValues.pointIndMap[arrayIndices[0]];
                        if (controlInd !== undefined) {
                            if (
                                direction === "symmetric" ||
                                (direction === "previous" &&
