        ...
        stateVariableDefinitions["n" + extremaClass.componentTypeCapitalized] =
            {
                ...
                definition: function ({ dependencyValues }) {
                    let extremeVarName =
                        "n" + extremaClass.componentTypeCapitalized;
                    return {
                        setValue: {
        ...
        stateVariableDefinitions[extremaClass.componentType] = {
            ...
            arrayVarNameFromPropIndex(propIndex, varName) {
                if (varName === extremaClass.componentType) {
                    if (propIndex.length === 1) {
                        return (
                            extremaClass.componentTypeSingular + propIndex[0]
                        );
                    } else {
            ...
            returnArrayDependenciesByKey({ arrayKeys, stateValues }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    let varName;
                    if (
                        stateValues.childIdentities[extremumInd]
                            .componentType ===
                        extremaClass.componentTypeSingular
                    ) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (child) {
                        ...
                        if (varName in child.stateValues) {
                            ...
                            extrema[arrayKey] =
                                child.stateValues["x" + (Number(dim) + 1)];
                        }
                    }
                }
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues[
                    ...
                    instructions.push({
                        setDependency:
                            dependencyNamesByKey[arrayKey].extremumChild,
                        desiredValue:
                            desiredStateVariableValues[
                                extremaClass.componentType
                            ][arrayKey],
