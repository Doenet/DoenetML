// This abstract component exists solely to allow different component types
...
export default class DirectionComponent extends BaseComponent {
    ...
    static returnSugarInstructions() {
        ...
        let wrapNonMathInMath = function ({
            matchedChildren,
            nComponents,
            stateIdInfo,
        }) {
    ...
    static returnStateVariableDefinitions() {
                    ...
                    instructions = [
                        {
                            ...
                            desiredValue:
                                desiredStateVariableValues.unnormalizedDirection,
                            childIndex: 0,
                            variableIndex: 0,
                        },
                    ];
        ...
        stateVariableDefinitions.direction = {
            ...
            arrayDefinitionByKey: function ({
                ...
                let directionTree =
                    globalDependencyValues.unnormalizedDirection.tree;
                if (
                    Array.isArray(directionTree) &&
                    vectorOperators.includes(directionTree[0])
                ) {
