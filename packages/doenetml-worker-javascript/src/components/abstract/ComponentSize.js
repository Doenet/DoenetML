                    ...
                    if (dependencyValues.numberChild.length === 0) {
                        if (dependencyValues.componentSizeChild.length === 0) {
                            ...
                            return {
                                setValue: {
                                    componentSize:
                                        dependencyValues.componentSizeChild[0]
                                            .stateValues.componentSize,
                                },
                            };
                        }
                    } else {
                        ...
                        return {
                            setValue: {
                                componentSize: {
                                    size: dependencyValues.numberChild[0]
                                        .stateValues.value,
                                    isAbsolute: true,
                                },
                            },
            ...
            inverseDefinition({
                ...
                if (dependencyValues.stringChild.length === 0) {
                                ...
                                instructions: [
                                    {
                                        ...
                                        desiredValue:
                                            desiredStateVariableValues.componentSize,
                                        childIndex: 0,
                                        variableIndex: 0,
                                    },
                                ],
                    ...
                    if (dependencyValues.numberChild.length > 0) {
                        ...
                        let originalUnit =
                            dependencyValues.stringChild[0].trim();
                        ...
                        let desiredSize =
                            desiredStateVariableValues.componentSize.size /
                            factor;
                ...
                for (let [
                    ...
                    if (
                        ...
                        let componentSizeListChild =
                            dependencyValues.componentSizeListChildren[
                                nComponentSizeLists
                            ];
                        nComponentSizeLists++;
                        for (
                            let i = 0;
                            i <
                            componentSizeListChild.stateValues.numComponents;
                            i++
                        ) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (child) {
                        if (
                            ...
                            componentSizes[arrayKey] =
                                child.stateValues.componentSize;
                        }
                    }
                }
                            ...
                            instructions.push({
                                setDependency:
                                    dependencyNamesByKey[arrayKey]
                                        .componentSizeAndComponentSizeListChildren,
                                desiredValue:
                                    desiredStateVariableValues.componentSizes[
                                        arrayKey
                                    ],
                                childIndex: 0,
                                variableIndex: 1,
