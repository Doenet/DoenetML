    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.value = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        value: dependencyValues.possibleValues[
            ...
            async inverseDefinition({
                ...
                if (dependencyValues.type === "number") {
                    ...
                    while (start < end - 1) {
                        ...
                        if (
                            (await stateValues.step) *
                                (dependencyValues.possibleValues[mid] -
                                    desiredValue) >
                            0
                        ) {
                            end = mid;
                    ...
                    let desiredValue = desiredStateVariableValues.value;
                    let index =
                        dependencyValues.possibleValues.indexOf(desiredValue);
                    if (index === -1) {
                        return { success: false };
                    } else {
                        return {
        ...
        stateVariableDefinitions.valueToIndex = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                for (let [
                    ind,
                    item,
                ] of dependencyValues.possibleValues.entries()) {
