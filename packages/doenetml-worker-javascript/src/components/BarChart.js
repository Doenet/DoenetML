...
export default class BarChart extends BlockComponent {
    ...
    static createAttributesObject() {
        ...
        // Read into `aspectRatioAttr` rather than straight into `aspectRatio`,
        // the same way `yMin` and `yMax` are, so that the ratio every consumer
        // reads has already been checked. See the `aspectRatio` state variable
        // below.
