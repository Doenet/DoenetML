...
describe("PointList tag tests @group1", async () => {
    ...
    `,
        ...
        let text2 = "(2345, 3.523), (0.5000, 5.252 * 10⁻¹³), (0.000, 0.000)";
        let text3 = "(2345.154, 3.523), (0.5, 0), (0, 0)";
        let text4 = "(2345.154, 3.523), (0.500, 0.000), (0.000, 0.000)";
        let text5 = "(2345.1535, 3.5234), (0.5, 5.25 * 10⁻¹³), (6 * 10⁻²¹, 0)";
        let text6 =
    ...
    it("compare unordered point lists", async () => {
        let { core, resolvePathToNodeIdx } = await createTestCore({
            doenetML: `
        ...
        <boolean name="b1">
            <pointList name="nl1" unordered="$unordered">(1,-4) (-8,3) (0,0)</pointList>
            =
            <pointList name="nl2">(0,0) (1,-4) (-8, 3)</pointList>
        </boolean>
        <boolean name="b2">$nl1 = $nl2</boolean>
        <boolean name="b3"><pointList extend="$nl1" name="nl1a" /> = <pointList extend="$nl2" /></boolean>
        <boolean name="b4"><pointList copy="$nl1" name="nl1b" /> = <pointList copy="$nl2" /></boolean>
