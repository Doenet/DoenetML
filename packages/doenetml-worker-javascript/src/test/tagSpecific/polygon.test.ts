...
describe("Polygon tag tests @group4", async () => {
  ...
  `,
    ...
    it("Reflect rigid polygon in sticky group", async () => {
        // Note: note actually using sticky group, as have only one item in there,
        // but making sure we are testing the code for sticky group constraints in reflection branch
        let { core, resolvePathToNodeIdx } = await createTestCore({
            doenetML: `
  <graph name="g1">
    <point>(3,7)</point>
