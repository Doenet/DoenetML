 ...
 * lightens each hue back over the dark canvas. Color words are pinned only
 * where the perceptual matcher's twelve-word vocabulary is too coarse (e.g.
 * "olive") or rounds a borderline hue to a neighbouring family.
 */
