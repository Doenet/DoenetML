...
export default class CobwebPolyline extends Polyline {
    ...
    static returnStateVariableDefinitions() {
                    ...
                    if (
                        ...
                        initialPoint[arrayKey] =
                            dependencyValuesByKey[
                                arrayKey
                            ].initialPointAttr.stateValues["x" + varEnding];
                    } else {
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.initialPoint) {
                    if (
                        dependencyValuesByKey[arrayKey].initialPointAttr &&
                        dependencyValuesByKey[arrayKey].initialPointAttr
                            .stateValues["x" + (Number(arrayKey) + 1)]
                    ) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].initialPointAttr,
                            desiredValue:
                                desiredStateVariableValues.initialPoint[
                                    arrayKey
                                ],
                            variableIndex: 0,
                        });
        ...
        stateVariableDefinitions.f = {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.functionAttr) {
                    return {
                        setValue: {
                            f: dependencyValues.functionAttr.stateValues
                                .numericalf,
                            fDefinition:
        ...
        stateVariableDefinitions.originalVertices = {
            ...
            arrayVarNameFromPropIndex(propIndex, varName) {
                ...
                if (varName.slice(0, 14) === "originalVertex") {
                    ...
                    if (
                        Number.isInteger(originalVertexNum) &&
                        originalVertexNum > 0
                    ) {
                        // if propIndex has additional entries, ignore them
                    ...
                    originalVertices[arrayKey] = {
                        get defaultValue() {
                            if (globalDependencyValues.defaultPoint) {
                                let xs =
                                    globalDependencyValues.defaultPoint
                                        .stateValues.xs;
            ...
            inverseArrayDefinitionByKey({ desiredStateVariableValues }) {
                ...
                for (let arrayKey in desiredStateVariableValues.originalVertices) {
                    instructions.push({
                        ...
                        value: {
                            [arrayKey]:
                                desiredStateVariableValues.originalVertices[
                                    arrayKey
                                ],
                        },
                    });
        ...
        stateVariableDefinitions.vertices.returnArrayDependenciesByKey =
            function ({ arrayKeys }) {
                    ...
                    if (pointInd === "0") {
                        ...
                        dependenciesByKey[arrayKey] = {
                            originalVertexX1: {
                                dependencyType: "stateVariable",
                                variableName:
                                    "originalVertexX" + pointInd + "_1",
                            },
                            originalVertexX2: {
                                dependencyType: "stateVariable",
                                variableName:
                                    "originalVertexX" + pointInd + "_2",
                            },
                            previousVertexX1: {
                                dependencyType: "stateVariable",
        ...
        stateVariableDefinitions.vertices.arrayDefinitionByKey = function ({
            ...
            for (let arrayKey of arrayKeys) {
                ...
                if (pointInd === "0") {
                    vertices[arrayKey] =
                        dependencyValuesByKey[arrayKey].initialPoint;
            ...
            async function ({
                ...
                for (let arrayKey in desiredStateVariableValues.vertices) {
                    ...
                    if (pointInd === "0") {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].initialPoint,
                            desiredValue:
        ...
        stateVariableDefinitions.fractionCorrectVerticesAdjusted = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.numIterationsRequired > 0) {
                    numVerticesRequired =
                        2 * dependencyValues.numIterationsRequired - 1;
                }
                ...
                if (numGradedVerticesAdjusted === 0) {
                    ...
                    fractionCorrectVerticesAdjusted =
                        dependencyValues.numCorrectVertices /
