    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.validIndependentVariable = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.independentVarAttr) {
                    validVariable =
                        dependencyValues.independentVarAttr.stateValues
                            .validVariable;
                }
                return {
                    setValue: { validIndependentVariable: validVariable },
                };
            },
        };
        ...
        stateVariableDefinitions.numDimensions = {
            ...
            definition: function ({ dependencyValues }) {
                return {
                    setValue: {
                        numDimensions: dependencyValues.rhsChildren.length,
                    },
        ...
        stateVariableDefinitions.variables = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                if (globalDependencyValues.variables !== null) {
                    ...
                    validVariables = [
                        ...globalDependencyValues.variables.stateValues
                            .validVariables,
                    ].slice(0, numDims);
                }
            ...
            arrayDefinitionByKey({ dependencyValuesByKey, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (dependencyValuesByKey[arrayKey].initialConditionAttr) {
                        let ic =
                            dependencyValuesByKey[arrayKey].initialConditionAttr
                                .stateValues[`math${Number(arrayKey) + 1}`];
                        if (ic !== undefined) {
                            foundValue = true;
        ...
        stateVariableDefinitions.latex = {
            ...
            definition({ dependencyValues }) {
                ...
                if (!dependencyValues.hideInitialCondition) {
                    let indVarVal0 =
                        dependencyValues.initialIndependentVariableValue;

                    for (
                        let dim = 0;
                        dim < dependencyValues.numDimensions;
                        dim++
                    ) {
                        let variable =
                            dependencyValues.variables[dim].toLatex();
            ...
            definition({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        ...
                        numericalRHSfDefinitions: dependencyValues.rhss.map(
                            (x) => ({
            ...
            arrayDefinitionByKey({
                ...
                for (
                    ...
                    numericalSolutions[ind] = function f(t) {
                        ...
                        let nChunksCalculated =
                            workspace.calculatedNumericSolutions.length;
                        ...
                        if (
                            ...
                            for (
                                let tind = nChunksCalculated;
                                tind <= chunk;
                                tind++
                            ) {
                                let x0 =
                                    workspace.endingNumericalValues[tind - 1];
                                if (x0 === undefined) {
                                    x0 = x0s;
                                }
                        ...
                        let value =
                            workspace.calculatedNumericSolutions[chunk](t)[ind];
