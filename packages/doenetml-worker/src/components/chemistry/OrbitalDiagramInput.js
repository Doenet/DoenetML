...
export default class OrbitalDiagramInput extends BlockComponent {
    ...
    static returnStateVariableDefinitions() {
                    ...
                    if (dependencyValues.prefill?.length > 0) {
                        ...
                        for (let [rowInd, row] of value.entries()) {
                            if (dependencyValues.prefillLabel[rowInd]) {
                                row.orbitalText =
                                    dependencyValues.prefillLabel[rowInd];
                            }
                        }
                    ...
                    instructions: [
                        {
                            setDependency: "value",
                            desiredValue: [
                                ...desiredStateVariableValues.rows,
                            ].reverse(),
                        },
                    ],
                };
        ...
        stateVariableDefinitions.selectedRowIndex = {
            ...
            definition: function () {
                return {
                    useEssentialOrDefaultValue: { selectedRowIndex: true },
                };
            },
            async inverseDefinition({
                ...
                let desiredRowIndex =
                    desiredStateVariableValues.selectedRowIndex;
        ...
        stateVariableDefinitions.selectedBoxIndex = {
            ...
            definition: function () {
                return {
                    useEssentialOrDefaultValue: { selectedBoxIndex: true },
                };
            },
            async inverseDefinition({ desiredStateVariableValues }) {
                let desiredBoxIndex =
                    desiredStateVariableValues.selectedBoxIndex;
