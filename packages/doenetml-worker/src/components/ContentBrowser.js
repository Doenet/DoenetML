    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.itemsByInitial = {
            additionalStateVariablesDefined: [
                ...
                {
                    variableName: "firstComponentNameByInitial",
                    forRenderer: true,
                },
                { variableName: "labelByInd" },
                {
                    variableName: "indByEscapedComponentName",
                    forRenderer: true,
                },
            ],
            returnDependencies: () => ({
            ...
            definition({ dependencyValues }) {
                ...
                for (let item of items) {
                    let newInitial =
                        Array.from(item.label)[0]?.toUpperCase() || "";
                    ...
                    if (newInitial === initial) {
                        ...
                        initial = newInitial;
                        initialList = [item];
                        firstComponentNameByInitial[initial] =
                            item.componentName;
                    }
                }
                if (initial) {
            ...
            definition({ dependencyValues }) {
                return {
                    useEssentialOrDefaultValue: {
                        initial: {
                            defaultValue:
                                dependencyValues.allInitials[0] || null,
                        },
                    },
                };
            },
                    ...
                    setValue: {
                        itemInfoForInitial:
                            dependencyValues.itemsByInitial[
                                dependencyValues.initial
                            ]?.map((x) => ({
                                label: x.label,
                                ind: x.ind,
                                componentName: x.componentName,
                                selected:
                                    x.ind === dependencyValues.selectedItemInd,
                            })) || [],
                    },
                };
            },
        ...
        stateVariableDefinitions.selectedItemLabel = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        selectedItemLabel:
                            dependencyValues.labelByInd[
                                dependencyValues.selectedItemInd
                            ] || "",
                    },
                };
            },
                ...
                return {
                    setValue: {
                        selectedItemComponentName:
                            dependencyValues.contentBrowserItems[0]
                                ?.componentName || "",
                    },
                };
            },
        ...
        stateVariableDefinitions.isSelected = {
            ...
            definition({ dependencyValues, componentName }) {
                return {
                    setValue: {
                        isSelected:
                            dependencyValues.selectedComponentName ===
                            componentName,
                    },
                };
            },
...
export class ContentBrowserContent extends Template {
    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.rendered = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: { rendered: dependencyValues.parentSelected },
                };
            },
        };
