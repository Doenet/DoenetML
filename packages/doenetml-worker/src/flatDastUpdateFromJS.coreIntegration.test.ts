...
describe("flatDastUpdateFromJS against a live JavaScript core", () => {
    it("turns a textInput action into a FlatDast update map", async () => {
        ...
        // Dispatch a real action that mutates a `forRenderer` state value, then
        // run the exact conversion that `CoreWorker.dispatchActionJavascriptFlat`
        // performs on the drained batches.
