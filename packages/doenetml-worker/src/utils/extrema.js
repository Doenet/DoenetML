                ...
                if (c[1] === 0) {
                    ...
                    if (xPt >= minx - buffer) {
                        if (c[0] < globalMinimum[1]) {
                            let atOpenBoundary =
                                openMin && Math.abs(xPt - minx) < buffer;
                            if (!atOpenBoundary) {
                    ...
                    if (x + xs[i] >= minx - buffer) {
                        if (x + xs[i] <= maxx + buffer) {
                            if (Math.abs(x) < eps) {
                                ...
                                let atOpenBoundary =
                                    (openMin &&
                                        Math.abs(x + xs[i] - minx) < buffer) ||
                                    (openMax &&
                                        Math.abs(x + xs[i] - maxx) < buffer);
                        ...
                        if (
                            ...
                            if (c[0] < globalMinimum[1]) {
                                ...
                                if (!atOpenBoundary1) {
                                    ...
                                    let atOpenBoundary2 =
                                        (openMin &&
                                            Math.abs(x2 - minx) < buffer) ||
                                        (openMax &&
                                            Math.abs(x2 - maxx) < buffer);
                                    if (!atOpenBoundary2) {
                                        ...
                                        let atOpenBoundary3 =
                                            (openMin &&
                                                Math.abs(x3 - minx) < buffer) ||
                                            (openMax &&
                                                Math.abs(x3 - maxx) < buffer);
                                        if (!atOpenBoundary3) {
            ...
            if (c[2] > 0) {
                ...
                if (
                    ...
                    if (Math.abs(x) < eps) {
                        ...
                        let atOpenBoundary =
                            (openMin &&
                                Math.abs(x + xs[xs.length - 2] - minx) <
                                    buffer) ||
                            (openMax &&
                                Math.abs(x + xs[xs.length - 2] - maxx) <
                                    buffer);
                        if (!atOpenBoundary) {
                            if (minimumAtPreviousRight) {
                                minimaList.push(pt);
                ...
                if (c[1] === 0) {
                    ...
                    if (xPt <= maxx + buffer) {
                        if (c[0] < globalMinimum[1]) {
                            let atOpenBoundary =
                                openMax && Math.abs(xPt - maxx) < buffer;
                            if (!atOpenBoundary) {
                                globalMinimum = [xPt, c[0]];
                            }
                        }
                ...
                if (x >= minx - buffer && x <= maxx + buffer) {
                    ...
                    if (
                        ...
                        if (
                            !atOpenBoundary &&
                            !(
                                addedAtPreviousRightViaDeriv &&
                                Math.abs(x - xleft) < buffer
                            )
                        ) {
                            minimaList.push([x, fx]);
                            addedAtPreviousRightViaDeriv =
                                Math.abs(x - xright) < buffer;
                ...
                if (x >= minx - buffer && x <= maxx + buffer) {
                    ...
                    if (
                        ...
                        if (numRecursions < 100) {
                            ...
                            let subDomainLeftOpen =
                                subDomainLeft === minx && openMin;
                            let subDomainRightOpen =
                                subDomainRight === maxx && openMax;
                            ...
                            if (
                                recursionResult.globalMinimum?.[1] <
                                globalMinimum[1]
                            ) {
                                globalMinimum = recursionResult.globalMinimum;
                            }
                            if (
                                recursionResult.globalInfimum?.[1] <
                                globalInfimum[1]
                            ) {
