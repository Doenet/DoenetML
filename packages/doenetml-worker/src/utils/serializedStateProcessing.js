            ...
            try {
                ...
                for (let prop of Object.keys(component.props)) {
                    ...
                    if (lowerCaseProp === "copytarget") {
                        ...
                        if (!haveComposite) {
                            component.props.createComponentOfType =
                                originalType;
                ...
                for (let prop of Object.keys(component.props)) {
                    ...
                    if (lowerCaseProp === "target") {
                        ...
                        if (typeof originalSource !== "string") {
                            ...
                            throw Error(
                                `Must supply value for ${propNameForError}.`,
                            );
                        }
                            ...
                            if (component.componentType === "copy") {
                                ...
                                if (
                                    ...
                                    !(
                                        ...
                                        component.attributes.propIndex
                                    )
                                ) {
...
function createComponentFromExtendedSource({
    ...
    for (let propObj of propArray) {
        ...
        if (propObj.attributes) {
            ...
            if (attributesResult.assignNames) {
                newComponent.props = {
                    assignNames: attributesResult.assignNames,
                };
            }
        }
    ...
    for (let ind = 0; ind < numComponents; ind++) {
        ...
        if (name) {
            if (
                ...
                let numberToSkip =
                    component.attributes.assignNamesSkip.primitive;
                if (numberToSkip > 0) {
