...
const parser = _lr.LRParser.deserialize({
  ...
  maxTerm: 40,
  context: _tokens.elementContext,
  nodeProps: [[_common.NodeProp.closedBy, 1, "SelfCloseEndTag EndTag", 10, "CloseTag MissingCloseTag"], [_common.NodeProp.openedBy, 17, "OpenTag"]],
  skippedNodes: [0],
  repeatNodeCount: 7,
  ...
  tokenizers: [_tokens.startTag, _tokens.commentContent, 0, 1, 2, 3, 4, 5],
  topRules: {
    "Document": [0, 6]
  },
  tokenPrec: 0
