import { u as L, q as J, j as m } from "./index-8862516e.js";
import Y, { useContext as j, useRef as S, useEffect as G } from "react";
import { BoardContext as w } from "./graph-de465854.js";
import "react-dom";
import "styled-components";
import "./css-ab4d83ca.js";
const H = Y.memo(function(k) {
  ...
  function B() {
    let { xmin: f, xmax: g, ymin: x, ymax: y } = n.graphLimits, o = (y - x) * 0.06, i = (g - f) * 0.05, C = (g - f) * 0.02, t = f + (g - f) * 0.05, O;
  ...
  return a ? ((!J(E.current, n.legendElements) || !J(U.current, n.graphLimits) || b.current !== n.position) && (c.current.length > 0 && v(), B()), E.current = [...n.legendElements], U.current = Object.assign({}, n.graphLimits), b.current = n.position, /* @__PURE__ */ m.jsx(m.Fragment, { children: /* @__PURE__ */ m.jsx("a", { name: _ }) })) : n.hidden ? null : /* @__PURE__ */ m.jsx(m.Fragment, { children: /* @__PURE__ */ m.jsx("a", { name: _ }) });
});
function X(h) {
