import { u as w, j as t, V as h } from "./index-8862516e.js";
import x, { useEffect as g } from "react";
import { s as i } from "./css-ab4d83ca.js";
import "react-dom";
import "styled-components";
const B = x.memo(function(b) {
  ...
  if (g(() => () => {
    ...
    if (e.encodedGeogebraContent) {
      let l = e, f = a, u = i(e.width), p = i(e.height);
  ...
  return e.geogebra ? /* @__PURE__ */ t.jsx(h, { partialVisibility: !0, onChange: d, children: /* @__PURE__ */ t.jsxs("div", { className: "geogebra", id: a, children: [
    ...
    /* @__PURE__ */ t.jsx(
      "iframe",
      {
        scrolling: "no",
        title: "",
        src: `https://www.geogebra.org/material/iframe/id/${e.geogebra}/width/${s}/height/${r}/border/888888/sfsb/true/smb/false/stb/false/stbh/false/ai/false/asb/false/sri/false/rc/false/ld/false/sdz/false/ctl/false`,
        width: s,
        height: r,
        style: { border: "0px" },
        children: " "
