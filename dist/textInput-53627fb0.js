import { u as ye, R as Ce, r as ke, C as oe, g as le, j as a, F as O, f as we, a as Ve, b as Ae, c as je, M as Ie } from "./index-dce15b2c.js";
...
import { BoardContext as Pe } from "./graph-b13204d4.js";
const I = ee.button`
  position: relative;
  height: 24px;
  width: 24px;
...
function se(u) {
  ...
  function P(n) {
    n.key === "Enter" && (N.current = C.current, f({
      action: p.updateValue,
      baseVariableValue: C.current
    }), e.includeCheckWork && !e.suppressCheckwork && !e.expanded && k === "unvalidated" && f({
  ...
  function R(n) {
    if (n.key === "Escape") {
      let r = N.current;
      r !== C.current && (W(r), V.current = e.immediateValue, f({
  ...
  function F(n) {
    te.current = !1, N.current = C.current, f({
      action: p.updateValue,
      baseVariableValue: C.current
    });
  }
  function L(n) {
    ...
    r !== C.current && (W(r), fe((x) => {
      let g = { ...x };
      return g.ignoreUpdate = !0, g;
    }), V.current = e.immediateValue, f({
      action: p.updateImmediateValue,
      args: {
        text: r
      },
  ...
  if (s) {
    ...
    return /* @__PURE__ */ a.jsx("a", { name: m });
  }
  if (e.hidden)
    return null;
  let G = e.disabled;
    ...
    if (k === "unvalidated")
      ...
      if (k === "correct")
        c.backgroundColor = getComputedStyle(
          document.documentElement
        ).getPropertyValue("--mainGreen"), d = /* @__PURE__ */ a.jsx(I, { id: m + "_correct", style: c, children: /* @__PURE__ */ a.jsx(O, { icon: Ve }) });
      else if (k === "partialcorrect") {
        let r = `${Math.round(e.creditAchieved * 100)} %`;
        c.width = "44px", c.backgroundColor = "#efab34", d = /* @__PURE__ */ a.jsx(I, { id: m + "_partial", style: c, children: r });
      } else
        c.backgroundColor = getComputedStyle(
          document.documentElement
        ).getPropertyValue("--mainRed"), d = /* @__PURE__ */ a.jsx(I, { id: m + "_incorrect", style: c, children: /* @__PURE__ */ a.jsx(O, { icon: Ae }) });
    else
      c.backgroundColor = "rgb(74, 3, 217)", c.padding = "1px 8px 1px 4px", d = /* @__PURE__ */ a.jsx(I, { id: m + "_saved", style: c, children: /* @__PURE__ */ a.jsx(O, { icon: je }) });
