...
for(let example of examples) {
  ...
  components.push(
    <pre key={"markup code" + example[0]} className='example-markup'><code className='language-xml'>{example[1]}</code></pre>
...
root.render(  
  ...
  <RecoilRoot>
    ...
    <pre><code className='language-html'>{ "<p>asdf</p>" }</code></pre>
