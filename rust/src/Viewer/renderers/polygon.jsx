...
export default React.memo(function Polygon(props) {
    ...
    function createPolygonJXG() {
        ...
        if (SVs.applyStyleToLabel) {
            jsxPolygonAttributes.label.strokeColor =
        ...
        newPolygonJXG.on("down", function (e) {
            ...
            pointsAtDown.current = newPolygonJXG.vertices.map((x) => [
                ...x.coords.scrCoords,
            ]);
        });
    ...
    if (board) {
        if (!polygonJXG.current) {
            ...
            if (SVs.nVertices > previousNVertices.current) {
                ...
                for (
                    let i = previousNVertices.current - 1;
                    i >= SVs.nVertices;
                    i--
                ) {
            ...
            if (
                ...
                polygonJXG.current.visProp.highlightfillcolor =
                    SVs.selectedStyle.fillColor;
                polygonJXG.current.visProp.hasinnerpoints =
                    SVs.selectedStyle.fillColor.toLowerCase() !== "none";
            }
            ...
            for (let i = 0; i < polygonJXG.current.borders.length; i++) {
                ...
                if (
                    ...
                    border.visProp.strokecolor = SVs.selectedStyle.lineColor;
                    border.visProp.highlightstrokecolor =
                        SVs.selectedStyle.lineColor;
                }
                if (
