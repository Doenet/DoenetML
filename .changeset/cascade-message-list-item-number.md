...
The message is now the child such a step lines its number up with, which is what it always was on the screen. Nothing changes once the step is revealed: the message is hidden then, and the content behind it leads as before.
