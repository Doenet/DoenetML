...
This applies to every dragged object in a graph, and to sliders. Typing is deliberately left alone: what an input shows, and the feedback beside it, still keep up with every keystroke.
