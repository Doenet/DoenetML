...
the same things are being sorted. A document that sorts forty dragged values and
reads the sorted list where it stands spends about a quarter of the time per
drag that it used to; the deeper cost of rearranging a parent's children is
