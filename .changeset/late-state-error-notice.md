...
What the host says is now a notice beside the document, in the reader's language and carrying the host's own words. The document, and the work in it, stay where they are, and the host is not told the document failed. A reader who cannot see the notice is told about it politely, without being interrupted in what they were doing. A reply the viewer cannot read — an error whose message is not text — costs a generic notice rather than the document.
